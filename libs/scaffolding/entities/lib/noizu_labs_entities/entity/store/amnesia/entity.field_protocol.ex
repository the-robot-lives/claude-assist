...
defprotocol Noizu.Entity.Store.Amnesia.Entity.FieldProtocol do
  ...
  # ⟦𓏗𓋉𓋼𓎋⟧ field_as_record :: auto-generated pointer for public function field_as_record
  ...
  @spec field_from_record(field, record, field_settings, persistence_settings, context, options) ::
          {:ok, any} | {:error, any}
  # ⟦𓎙𓌁𓄜𓈓⟧ field_from_record :: auto-generated pointer for public function field_from_record
