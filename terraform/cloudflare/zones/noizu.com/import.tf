# Import blocks for existing noizu.com zone + DNS records

import {
  to = cloudflare_zone.this
  id = "46014d24206a7141ed698d2d9d963e85"
}
...
import {
  ...
  id = "46014d24206a7141ed698d2d9d963e85/b4524e57d60deaa14d1581d08e596c30"
}

import {
  to = cloudflare_dns_record.cluster["inference"]
  id = "46014d24206a7141ed698d2d9d963e85/6a10f86cd7892759de5e8ee4720dcf45"
}

import {
  to = cloudflare_dns_record.cluster["kimai"]
  id = "46014d24206a7141ed698d2d9d963e85/ae421443a147fb4c015e12c65623ae45"
}

import {
  to = cloudflare_dns_record.cluster["minio"]
  id = "46014d24206a7141ed698d2d9d963e85/9fffcdb98f64151d132aa272ae34a61c"
}

import {
  to = cloudflare_dns_record.cluster["minio-console"]
  id = "46014d24206a7141ed698d2d9d963e85/16096c143be400c39f58c83e34d81a8f"
}

import {
  to = cloudflare_dns_record.cluster["npm"]
  id = "46014d24206a7141ed698d2d9d963e85/f917ba23b2f60669c78e1f1bac0e0bc4"
}
