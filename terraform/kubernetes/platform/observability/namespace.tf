# ---------------------------------------------------------------------------
# Platform-observability tier namespace. Holds OneUptime (uptime monitoring +
# incident management). Credentials managed by Infisical.
# ---------------------------------------------------------------------------
...
locals {
  ns = kubernetes_namespace_v1.observability.metadata[0].name

  common_labels = {
    "app.kubernetes.io/part-of"    = "noizu-platform-observability"
