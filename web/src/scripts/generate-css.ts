/**
 * Runs the engine's CSS generation with our config directory.
 * Resolves the engine through the installed npm package.
 */
...
execSync("npx tsx src/generate.ts", {
  ...
  env: {
    ...process.env,
    NODE_PATH: path.join(STARTER_ROOT, "node_modules"),
