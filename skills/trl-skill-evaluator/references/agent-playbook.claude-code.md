...
- **trl-skill-engineer** — Consumes eval issues and patches to improve skills
- **trl-site-walkthrough** — Provides directed graph patterns, persona evaluation, and issue lifecycle
- **trl-agentic-harness-engineer** — Provides scoring functions, CI integration patterns
