...
A complete walkthrough of evaluating the `trl-skill-engineer` skill end-to-end.
...
The evaluator reads:
- `~/.claude/skills/trl-skill-engineer/SKILL.md` (380 lines)
- `~/.claude/skills/trl-skill-engineer/references/agent-playbook.claude-code.md` (941 lines)
