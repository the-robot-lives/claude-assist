...
- **JavaScript-framework SPAs** (React, Vue, Svelte) — see `react-engineer`
- **Server-state LiveView / Surface** as the primary tool — this skill contrasts with them but builds in Hologram
- **General Elixir/OTP backend architecture** — see `noizu-frameworks`

> For React/Next.js SPA engineering, see **react-engineer**.
> For Elixir framework and OTP backend patterns, see **noizu-frameworks**.
> For design-system / landing-page visual design, see **user-experience-engineer**.
> For web-component (Lit) UIs, see **lit-dev**.
...
- **react-engineer** — JS-framework SPAs when Hologram/Elixir isn't the stack
- **noizu-frameworks** — Elixir/OTP backend patterns behind Hologram commands
- **user-experience-engineer** — Visual design systems and landing pages
- **lit-dev** — Standards-based web components for non-Elixir UIs
- **skill-engineer** — Meta-skill for creating and evaluating skills
