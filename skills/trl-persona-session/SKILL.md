...
> For designing the persona's character definition from scratch, see **trl-agent-architect** (persona design) and `references/persona-definition-schema.md` here.
...
- **trl-agent-architect** — design the persona's character (voice signature, OCEAN traits, expertise graph) before adopting it
- **trl-skill-engineer** — the meta-skill this skill was built with; use it to evaluate or extend this skill
