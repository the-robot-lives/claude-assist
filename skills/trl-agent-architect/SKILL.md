...
> For building MCP servers that agents consume, see **trl-mcp-architect** or **trl-mcp-forge**.
> For Kubernetes-specific agent patterns, see **trl-kubernetes-engineer**.
> For packaging agents as sellable products, see **trl-ai-templates**.
...
- **trl-skill-engineer** — Meta-skill for building any skill (not just agents)
- **trl-mcp-architect** — Design MCP servers that agents consume
- **trl-mcp-forge** — Build and deploy MCP servers
- **trl-kubernetes-engineer** — K8s-specific agent patterns
- **trl-threat-modeler** — Security analysis for agent systems
- **trl-ai-templates** — Package agents as products
