---
name: trl-react-engineer
description: >-
  Build, debug, and modernize production React 19/Next.js 15–16 apps: RSC, App Router, routing/history, state, rendering, performance, SEO, and cost. Use for components, hydration, Redux/Zustand, SSR/SSG/ISR/PPR, Core Web Vitals, or migrations.
...
ch-description: >-
  建置、除錯並現代化 React 19／Next.js 15–16 應用：涵蓋 RSC、App Router、路由與歷史、狀態、渲染、效能、SEO 與成本。適用於元件、hydration、Redux／Zustand、SSR／SSG／ISR／PPR、Core Web Vitals 或遷移。
---
...
- Design system creation (see `trl-user-experience-engineer`)
...
> For UI/UX design and component libraries, see `trl-user-experience-engineer`.
...
- **trl-user-experience-engineer** — Component library design, accessibility audits, UI mockups
- **trl-kubernetes-engineer** — Deploying Next.js on Kubernetes with Helm charts
- **trl-threat-modeler** — Security review of RSC endpoints and Server Actions
