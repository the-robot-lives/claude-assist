...
Quality scoring template for evaluating skills. Use after completing the quality checklist (`references/quality-checklist.md`). Use together with references/quality-checklist.md (59/65 pass gate) — the rubric scores quality depth, the checklist gates structural compliance.
...
- [ ] INTRODUCTION.md exists at skill root with valid contract
...
**Scoring guide:**
- 9-10: Perfect compliance; follows trl-user-experience-engineer exemplar formatting
