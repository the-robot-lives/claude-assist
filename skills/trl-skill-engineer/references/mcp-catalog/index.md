...
|----------|------|-------------|-----------|
| AI Coding Assistants | `ai-coding-assistants.md` | 12 | 5 |
| Code Analysis | `code-analysis.md` | 8 | 5 |
| Data & Databases | `data-and-databases.md` | 9 | 5 |
| Design & UI | `design-and-ui.md` | 6 | 5 |
| DevOps & Infrastructure | `devops-and-infra.md` | 7 | 7 |
| File & Knowledge | `file-and-knowledge.md` | 8 | 4 |
| Git & GitHub | `git-and-github.md` | 5 | 2 |
| LLM & Prompt Tools | `llm-and-prompt.md` | 1 | 5 |
| Monitoring & Observability | `monitoring-and-observability.md` | 3 | 0 |
| Search & Web | `search-and-web.md` | 8 | 1 |
| Security & Auth | `security-and-auth.md` | 4 | 2 |
| Testing & QA | `testing-and-qa.md` | 5 | 2 |
| Workflow & Automation | `workflow-and-automation.md` | 8 | 0 |

**Total: 127 tools cataloged (84 MCP servers, 43 CLI tools)**
