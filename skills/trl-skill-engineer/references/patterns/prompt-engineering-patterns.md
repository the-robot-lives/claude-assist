...
**Status:** Table stakes. Still mandatory for base models. Redundant when using extended-thinking / reasoning models (e.g. Claude Opus 4.8+ extended thinking, GPT-5 reasoning modes).  
