...
Discovery ends at 8/8, or at 6+ when the user approves the documented gaps.
...
- Constraints are standard and unstated. If no environment is specified, design harness-agnostic (portable across Claude Code, Claude Teams, Codex, Grok) and document that choice.
