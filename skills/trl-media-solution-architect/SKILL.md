...
- **trl-kubernetes-engineer** — K8s cluster setup, Helm charts, and workload management for hosting media infrastructure
- **trl-terraform-engineer** — Infrastructure provisioning for edge locations, DNS, and networking
- **trl-dba-db-designer-and-tuning** — Database optimization for viewer analytics and content metadata at scale
