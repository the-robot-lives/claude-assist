...
> For site SEO and discoverability audits, see **trl-seo-guru** skill.
> For UX design and interface evaluation, see **trl-user-experience-engineer** skill.
...
```
/trl-site-walkthrough journey greenthumb.shop purchase-plant
```
...
```
/trl-site-walkthrough journey greenthumb.shop purchase-plant --persona maria-low-vision
```
...
```
/trl-site-walkthrough journey-report greenthumb.shop purchase-plant
```
...
```
/trl-site-walkthrough retest greenthumb.shop purchase-plant
```
...
```
/trl-site-walkthrough diff greenthumb.shop purchase-plant 20260528-143022-a7b3 20260605-091500-c4d2
```
...
```
/trl-site-walkthrough heatmap greenthumb.shop purchase-plant
```
...
1. `/trl-site-walkthrough register mysite.com` — creates directory structure
2. Explore the site manually or provide a sitemap
3. `/trl-site-walkthrough inventory mysite.com /` — inventory the home page
4. Repeat for key pages
5. `/trl-site-walkthrough goal mysite.com "sign up for newsletter"` — define first goal
6. `/trl-site-walkthrough generate mysite.com` — produce graphs and walkthroughs
...
2. `/trl-site-walkthrough journey mysite.com sign-up-flow` — creates fingerprinted run for all personas
...
6. `/trl-site-walkthrough retest mysite.com sign-up-flow` — new fingerprinted run, auto-diff against previous

### Audit an Existing Site Registry
1. `/trl-site-walkthrough audit mysite.com`
...
- **trl-seo-guru** — Audit site discoverability and search engine optimization
- **trl-user-experience-engineer** — Design and evaluate user interfaces and interaction patterns
- **trl-kubernetes-engineer** — Deploy and manage the infrastructure hosting these sites
