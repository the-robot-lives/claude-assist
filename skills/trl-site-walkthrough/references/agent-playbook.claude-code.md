...
```
"/trl-site-walkthrough register [DOMAIN]"
...
steps:
  ...
  - id: report
    ...
    description: >
      ...
      "Site registered. Next: inventory pages with /trl-site-walkthrough inventory {domain} /"
...
```
"/trl-site-walkthrough inventory [DOMAIN] [PATH]"
...
```
"/trl-site-walkthrough goal [DOMAIN] [GOAL_DESCRIPTION]"
...
```
"/trl-site-walkthrough generate [DOMAIN]"
...
```
"/trl-site-walkthrough audit [DOMAIN]"
...
```
"/trl-site-walkthrough journey [DOMAIN] [GOAL] [--persona PERSONA_ID]"
...
```
"/trl-site-walkthrough journey-report [DOMAIN] [GOAL]"
...
```
"/trl-site-walkthrough retest [DOMAIN] [GOAL]"
...
```
"/trl-site-walkthrough heatmap [DOMAIN] [GOAL]"
