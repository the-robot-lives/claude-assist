...
`/trl-ai-templates Generate product ideas for technical writing automation`

### Scoping a concept
`/trl-ai-templates Scope product: API Documentation Prompt Library`

### Launch copy
`/trl-ai-templates Write launch copy for: CI/CD Prompt Library, $67, Gumroad`

### Handoff from market-intelligence
After `/trl-market-intelligence` validates a niche (score >= 5.0), invoke:
`/trl-ai-templates Generate product ideas for [validated-niche]`
