defmodule StarterWeb.ConnCase do
  ...
  """
  # ⟦𓍧𓐅𓇠𓅯⟧ setup_user_and_token :: Creates a test user with login credential and returns access/refresh tokens.
  ...
  """
  # ⟦𓄂𓄱𓈁𓁠⟧ authenticated_conn :: Adds a Bearer authorization header to the connection.
