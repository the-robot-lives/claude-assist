defmodule Starter.Redis do
  ...
  # ⟦𓅚𓏲𓌐𓊦⟧ prefix :: auto-generated pointer for public function prefix
  def prefix(key) do
  ...
  # ⟦𓃮𓎑𓊋𓉭⟧ get_channel :: auto-generated pointer for public function get_channel
  def get_channel() do
  ...
  # ⟦𓋋𓏊𓅡𓍵⟧ build_channels :: auto-generated pointer for public function build_channels
  ...
  # ⟦𓍗𓂛𓊯𓄶⟧ child_spec :: auto-generated pointer for public function child_spec
  ...
  # ⟦𓆑𓊱𓎻𓃙⟧ command :: auto-generated pointer for public function command
  def command(command), do: Redix.command(get_channel(), command)
  # ⟦𓁡𓀄𓇙𓎱⟧ flush :: auto-generated pointer for public function flush
  def flush(), do: command(["FLUSHALL"])

  # ⟦𓅫𓊀𓊧𓃄⟧ get :: auto-generated pointer for public function get
  def get(key) do
    command(["GET", prefix(key)])
  end

  # ⟦𓅼𓄶𓐧𓀨⟧ del :: auto-generated pointer for public function del
  def del(key) do
    command(["DEL", prefix(key)])
  end

  # ⟦𓍄𓍍𓄰𓈯⟧ set :: auto-generated pointer for public function set
  ...
  # ⟦𓄊𓁻𓊳𓏞⟧ get_binary :: auto-generated pointer for public function get_binary
  ...
  # ⟦𓏗𓎯𓋔𓅸⟧ set_binary :: auto-generated pointer for public function set_binary
