defmodule StarterWeb.Hologram.Pages.SignupPage do
  ...
  def action(:register_ok, params, component) do
    page =
      case Auth.post_auth_path(params.user) do
        "/pending-approval" -> StarterWeb.Hologram.Pages.PendingApprovalPage
        _ -> StarterWeb.Hologram.Pages.AppHomePage
      end
