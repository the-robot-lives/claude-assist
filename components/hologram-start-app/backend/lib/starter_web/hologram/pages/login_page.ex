defmodule StarterWeb.Hologram.Pages.LoginPage do
  @moduledoc """
  ...
  alias StarterWeb.Hologram.Pages.ForgotPasswordPage
  ...
  defp path_to_page("/pending-approval"), do: StarterWeb.Hologram.Pages.PendingApprovalPage
  defp path_to_page("/complete-registration"),
    do: StarterWeb.Hologram.Pages.CompleteRegistrationPage

  defp path_to_page(_), do: StarterWeb.Hologram.Pages.AppHomePage
end
