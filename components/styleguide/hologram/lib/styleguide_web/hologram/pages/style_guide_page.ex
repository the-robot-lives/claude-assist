defmodule StyleguideWeb.Hologram.Pages.StyleGuidePage do
  @moduledoc """
  Interactive style guide viewer at `/style-guide`.

  Visual Foundation, Structure, Interaction (incl. HUI submenu), Component Browser,
  and Reference. Tailwind Plus full catalog at `/style-guide/tailwind-plus`.
  """
  use Hologram.Page
  ...
  alias StyleguideWeb.Hologram.Components.{
    Card,
    CardGrid,
    InputField,
    SectionHeader,
  ...
  alias StyleguideWeb.Hologram.Sections.{
    ColorPalette,
    ComponentBrowser,
    HuiShowcase,
    ShellLayouts,
        ...
        {%if @section_id == "navigation"}
          <div class="demo-block">
            ...
            <p style="color: var(--text-muted); font-size: var(--font-size-sm); margin-top: var(--space-3)">
              ...
              or
              <a href="/style-guide/tailwind-plus" class="btn btn-black btn-sm">Full browser</a>
            </p>
          </div>
        {/if}
        ...
        {%if @section_id == "migration"}
          <div class="demo-block">
            ...
            <div class="card-grid-actions">
              ...
              <a href="/style-guide/tailwind-plus" class="card card--link">
        ...
        {%if @section_id == "tailwind-plus"}
          <div class="demo-block">
            <p class="sg-page-intro" style="color: var(--text-secondary); margin-bottom: var(--space-3)">
              ...
              navigation and demos at /style-guide/tailwind-plus.
            </p>
            ...
            <div class="twp-quick-links">
              <a href="/style-guide/tailwind-plus" class="card twp-quick-link">
