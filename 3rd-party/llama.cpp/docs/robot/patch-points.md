...
| Donor model classes `llama_model_llama`, `llama_model_qwen2`, `llama_model_qwen2moe`, `llama_model_qwen3`, `llama_model_qwen35`, `llama_model_mamba` (`src/models/models.h`) | `llama_robot_model_mapping()` | constructor signature `(const llama_model_params &)` |
