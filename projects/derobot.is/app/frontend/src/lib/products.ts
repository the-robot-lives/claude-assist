...
export const products: Product[] = [
  ...
  { name: "TheRobotDrafts", domain: "draft.therobotplans.com", category: "Dev Tools", oneLiner: "Model, connect, and export software architecture in an interactive 3D scene" },
  { name: "TheRobotPlans", domain: "therobotplans.com", category: "Productivity", oneLiner: "Your operational life — personal and professional — run by a team of AI agents" },
  { name: "Timely", domain: "timely.noizu.com", category: "Productivity", oneLiner: "Precision time tracking as an evidence-backed activity ledger" },
  ...
  { name: "TheRobotLearns", domain: "therobotlearns.com", category: "Social / Knowledge", oneLiner: "Cloud learning workspace that turns study sessions into durable knowledge" },
...
export const categories = ["Gaming", "Dev Tools", "Productivity", "Social / Knowledge", "Infrastructure", "Security"] as const;
