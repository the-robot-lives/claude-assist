defmodule TherobotsdayjobWeb.Router do
  use TherobotsdayjobWeb, :router
  ...
  pipeline :authenticated do
    plug TherobotsdayjobWeb.AuthPipeline
  end
  ...
  pipeline :rate_limited_auth do
    plug TherobotsdayjobWeb.Plugs.RateLimit, action: :auth
  end

  pipeline :rate_limited_sensitive do
    plug TherobotsdayjobWeb.Plugs.RateLimit, action: :auth_sensitive
  end

  pipeline :org_viewer do
    plug TherobotsdayjobWeb.Plugs.RequireRole, role: "viewer"
  end

  pipeline :org_editor do
    plug TherobotsdayjobWeb.Plugs.RequireRole, role: "editor"
  end

  pipeline :org_admin do
    plug TherobotsdayjobWeb.Plugs.RequireRole, role: "admin"
  end

  pipeline :org_owner do
    plug TherobotsdayjobWeb.Plugs.RequireRole, role: "owner"
  end

  pipeline :admin do
    plug TherobotsdayjobWeb.Plugs.RequireAdmin
  end

  scope "/", TherobotsdayjobWeb do
    pipe_through :api
    get "/health", HealthController, :index
  end

  scope "/api/v1", TherobotsdayjobWeb do
  ...
  scope "/media", TherobotsdayjobWeb do
    pipe_through [:api]
  ...
  if Application.compile_env(:therobotsdayjob, :saml_enabled) do
    scope "/sso/saml" do
  ...
  # OIDC redirect flow
  scope "/auth/oidc", TherobotsdayjobWeb do
    pipe_through [:sso_session]
  ...
  scope "/auth", TherobotsdayjobWeb do
    pipe_through [:sso_session]
  ...
  if Application.compile_env(:therobotsdayjob, :dev_routes) do
    import Phoenix.LiveDashboard.Router

    scope "/dev" do
      pipe_through [:fetch_session, :protect_from_forgery]
      live_dashboard "/dashboard", metrics: TherobotsdayjobWeb.Telemetry
    end
  end
end
