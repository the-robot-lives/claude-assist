defmodule TherobotsdayjobWeb.UserController do
  use TherobotsdayjobWeb, :controller

  alias Therobotsdayjob.Guardian
  alias Therobotsdayjob.Users
  ...
  defp get_current_user(conn) do
    ...
    case session.user do
      ...
      %Therobotsdayjob.Users.User{} = user ->
        user
    end
  end
  ...
  defp validate_update_params(user, params) do
    if params["new_password"] && params["current_password"] do
      ...
      q =
        from c in Therobotsdayjob.Schema.Users.Credentials.UserCredential,
  ...
  defp apply_updates(user, params, _context) do
    ...
    if map_size(updates) > 0 do
      ...
      |> Therobotsdayjob.Repo.update_all(set: Enum.to_list(updates))
    end

    if params["new_password"] do
      Therobotsdayjob.Users.Credentials.update_password(user, params["new_password"], Noizu.Context.system())
    end
