defmodule TherobotsdayjobWeb.PolicyController do
  use TherobotsdayjobWeb, :controller

  alias Therobotsdayjob.Authz
  alias Therobotsdayjob.Authz.Policies
  ...
  def show(conn, %{"id" => id}) do
    case Therobotsdayjob.Repo.get(Therobotsdayjob.Schema.Authz.Policy, id) do
