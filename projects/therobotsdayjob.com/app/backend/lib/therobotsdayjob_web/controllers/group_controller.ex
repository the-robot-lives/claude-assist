defmodule TherobotsdayjobWeb.GroupController do
  use TherobotsdayjobWeb, :controller

  alias Therobotsdayjob.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Therobotsdayjob.Repo.get(Therobotsdayjob.Schema.Authz.Group, id), else: Groups.get_by_name(id)
