defmodule TherobotsdayjobWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Therobotsdayjob.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Therobotsdayjob.Users.Sessions.UserSession{} = session) do
