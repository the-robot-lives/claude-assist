defmodule Therobotsdayjob.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotsdayjob.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Therobotsdayjob.Schema.Organizations.InviteToken, Therobotsdayjob.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Therobotsdayjob.Users.UserReference
