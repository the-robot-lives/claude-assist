defmodule Therobotsdayjob.Projects.Project do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotsdayjob.Projects
  @sref "project"
  @persistence ecto_store(Therobotsdayjob.Schema.Projects.Project, Therobotsdayjob.Repo)
