defmodule Therobotsdayjob.Authz.ScopedMemberships do
  alias Therobotsdayjob.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Therobotsdayjob.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Therobotsdayjob.Schema.Users.User, on: u.id == sm.member_id,
