defmodule Therobotsdayjob.Versioned.Strings do
  alias Therobotsdayjob.Versioned.Strings.String, as: Entity
  alias Therobotsdayjob.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
