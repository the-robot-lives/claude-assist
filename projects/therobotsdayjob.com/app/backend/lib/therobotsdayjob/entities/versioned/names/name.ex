defmodule Therobotsdayjob.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotsdayjob.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Therobotsdayjob.Schema.Versioned.Names.Name, Therobotsdayjob.Repo)
