defmodule Therobotsdayjob.Versioned.Names do
  alias Therobotsdayjob.Versioned.Names.Name, as: Entity
  alias Therobotsdayjob.Schema.Versioned.Names.Name, as: Schema
  use Noizu.Repo
