defmodule Therobotsdayjob.Versioned.Descriptions do
  alias Therobotsdayjob.Versioned.Descriptions.Description, as: Entity
  alias Therobotsdayjob.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
