defmodule Therobotsdayjob.Guardian do
  use Guardian, otp_app: :therobotsdayjob

  def subject_for_token(%Therobotsdayjob.Users.Sessions.UserSession{} = session, _claims) do
