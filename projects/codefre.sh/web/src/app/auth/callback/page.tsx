  ...
  if (error) {
    return (
      <div className="text-center">
        <p className="text-sm text-eval-fail mb-4">{error}</p>
        <a
          href="/"
          className="font-mono text-[11px] uppercase tracking-[0.08em] text-accent hover:text-accent-hover transition-colors"
        >
          Back to home
        </a>
      </div>
