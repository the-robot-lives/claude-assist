defmodule Codefresh.Versioned.Strings do
  alias Codefresh.Versioned.Strings.String, as: Entity
  alias Codefresh.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
  ...
  def create(%Entity{} = string, context, options) do
