defmodule Codefresh.Versioned.Descriptions do
  alias Codefresh.Versioned.Descriptions.Description, as: Entity
  alias Codefresh.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
