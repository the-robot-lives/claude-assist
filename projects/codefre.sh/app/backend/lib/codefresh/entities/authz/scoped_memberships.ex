defmodule Codefresh.Authz.ScopedMemberships do
  alias Codefresh.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Codefresh.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Codefresh.Schema.Users.User, on: u.id == sm.member_id,
