defmodule Codefresh.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Codefresh.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Codefresh.Schema.Organizations.InviteToken, Codefresh.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Codefresh.Users.UserReference
