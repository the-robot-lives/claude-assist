defmodule Codefresh.Users.Sessions do
  @moduledoc """
  Context for Codefresh.Users.Sessions
  """
  alias Codefresh.Users.Sessions.UserSession, as: Entity
  alias Codefresh.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Codefresh.Users.Sessions.UserSession)
