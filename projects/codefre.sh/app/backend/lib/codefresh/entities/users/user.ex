defmodule Codefresh.Users.User do
  use Noizu.Entities

  @vsn 1.0
  @repo Codefresh.Users
  @sref "user"
  @persistence ecto_store(Codefresh.Schema.Users.User, Codefresh.Repo)
  ...
  def_entity do
    ...
    @config auto: true
    @store name: :name_id
    field :name, nil, Codefresh.Versioned.Names.NameReference
    ...
    field :status, nil, {:ecto, Codefresh.Schema.Users.User.__schema__(:type, :status)}
