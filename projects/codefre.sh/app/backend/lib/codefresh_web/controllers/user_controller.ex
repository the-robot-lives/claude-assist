defmodule CodefreshWeb.UserController do
  use CodefreshWeb, :controller

  alias Codefresh.Guardian
  alias Codefresh.Users
  ...
  defp validate_update_params(user, params) do
    if params["new_password"] && params["current_password"] do
      ...
      q =
        from c in Codefresh.Schema.Users.Credentials.UserCredential,
  ...
  defp apply_updates(user, params, _context) do
    ...
    if map_size(updates) > 0 do
      ...
      |> Codefresh.Repo.update_all(set: Enum.to_list(updates))
    end
