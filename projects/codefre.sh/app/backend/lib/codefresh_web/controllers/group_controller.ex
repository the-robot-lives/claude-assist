defmodule CodefreshWeb.GroupController do
  use CodefreshWeb, :controller

  alias Codefresh.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Codefresh.Repo.get(Codefresh.Schema.Authz.Group, id), else: Groups.get_by_name(id)
