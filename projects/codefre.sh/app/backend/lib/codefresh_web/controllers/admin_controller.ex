defmodule CodefreshWeb.AdminController do
  use CodefreshWeb, :controller

  alias Codefresh.Schema.Users.User, as: UserSchema
  alias Codefresh.Schema.Organizations.Organization, as: OrgSchema
  import Ecto.Query
  ...
  def show_organization(conn, %{"id" => id}) do
    case Codefresh.Repo.get(OrgSchema, id) do
      nil ->
