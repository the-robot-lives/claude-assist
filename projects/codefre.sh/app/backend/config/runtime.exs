...
if config_env() == :prod do
  ...
  config :codefresh, :frontend_url, System.get_env("FRONTEND_URL")
  ...
  if s3_bucket = System.get_env("S3_BUCKET") do
    config :codefresh, Codefresh.Storage,
      bucket: s3_bucket,
  ...
  config :codefresh, :sso_require_invite, System.get_env("SSO_REQUIRE_INVITE") == "true"
  ...
  #     config :codefresh, :linkedin_enabled, true
