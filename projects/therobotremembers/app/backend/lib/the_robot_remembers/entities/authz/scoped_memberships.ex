defmodule TheRobotRemembers.Authz.ScopedMemberships do
  alias TheRobotRemembers.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias TheRobotRemembers.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in TheRobotRemembers.Schema.Users.User, on: u.id == sm.member_id,
