defmodule TheRobotRemembers.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo TheRobotRemembers.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(TheRobotRemembers.Schema.Versioned.Names.Name, TheRobotRemembers.Repo)
