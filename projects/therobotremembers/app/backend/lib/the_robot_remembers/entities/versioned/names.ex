defmodule TheRobotRemembers.Versioned.Names do
  alias TheRobotRemembers.Versioned.Names.Name, as: Entity
  alias TheRobotRemembers.Schema.Versioned.Names.Name, as: Schema
  use Noizu.Repo
