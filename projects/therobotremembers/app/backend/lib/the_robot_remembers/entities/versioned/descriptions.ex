defmodule TheRobotRemembers.Versioned.Descriptions do
  alias TheRobotRemembers.Versioned.Descriptions.Description, as: Entity
  alias TheRobotRemembers.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
