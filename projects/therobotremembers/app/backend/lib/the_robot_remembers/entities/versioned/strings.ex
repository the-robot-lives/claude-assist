defmodule TheRobotRemembers.Versioned.Strings do
  alias TheRobotRemembers.Versioned.Strings.String, as: Entity
  alias TheRobotRemembers.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
