defmodule TheRobotRemembers.Projects.Project do
  use Noizu.Entities

  @vsn 1.0
  @repo TheRobotRemembers.Projects
  @sref "project"
  @persistence ecto_store(TheRobotRemembers.Schema.Projects.Project, TheRobotRemembers.Repo)
