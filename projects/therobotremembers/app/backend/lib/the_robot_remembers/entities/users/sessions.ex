defmodule TheRobotRemembers.Users.Sessions do
  @moduledoc """
  Context for TheRobotRemembers.Users.Sessions
  """
  alias TheRobotRemembers.Users.Sessions.UserSession, as: Entity
  alias TheRobotRemembers.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: TheRobotRemembers.Users.Sessions.UserSession)
