defmodule TheRobotRemembers.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo TheRobotRemembers.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(TheRobotRemembers.Schema.Organizations.InviteToken, TheRobotRemembers.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, TheRobotRemembers.Users.UserReference
