defmodule TheRobotRemembers.Guardian do
  use Guardian, otp_app: :the_robot_remembers

  def subject_for_token(%TheRobotRemembers.Users.Sessions.UserSession{} = session, _claims) do
