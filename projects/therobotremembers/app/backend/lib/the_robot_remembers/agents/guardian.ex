defmodule TheRobotRemembers.Agents.Guardian do
  @moduledoc """
  The Guardian gates ingest. PHASE 0: cheap inline checks only — content present, length
  bound, and a prompt-injection/poisoning heuristic. Deep semantic contradiction (an LLM
  seam) arrives in Phase 3. Returns `:ok` or `{:quarantine, reason}`.
  """
