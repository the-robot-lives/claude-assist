defmodule TheRobotRemembersWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case TheRobotRemembers.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%TheRobotRemembers.Users.Sessions.UserSession{} = session) do
