defmodule TheRobotRemembersWeb.GroupController do
  use TheRobotRemembersWeb, :controller

  alias TheRobotRemembers.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: TheRobotRemembers.Repo.get(TheRobotRemembers.Schema.Authz.Group, id), else: Groups.get_by_name(id)
