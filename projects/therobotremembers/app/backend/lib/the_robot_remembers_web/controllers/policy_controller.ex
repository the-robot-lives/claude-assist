defmodule TheRobotRemembersWeb.PolicyController do
  use TheRobotRemembersWeb, :controller

  alias TheRobotRemembers.Authz
  alias TheRobotRemembers.Authz.Policies
  ...
  def show(conn, %{"id" => id}) do
    case TheRobotRemembers.Repo.get(TheRobotRemembers.Schema.Authz.Policy, id) do
