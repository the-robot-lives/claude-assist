defmodule TheRobotLearnsWeb.AdminController do
  use TheRobotLearnsWeb, :controller

  alias TheRobotLearns.Schema.Users.User, as: UserSchema
  alias TheRobotLearns.Schema.Organizations.Organization, as: OrgSchema
  import Ecto.Query
  ...
  def approve_user(conn, %{"id" => id}) do
    ...
    case TheRobotLearns.Repo.get(UserSchema, id) do
      ...
      user ->
        ...
        case user |> UserSchema.changeset(attrs) |> TheRobotLearns.Repo.update() do
          {:ok, updated_user} ->
  ...
  def list_organizations(conn, params) do
    ...
    total = TheRobotLearns.Repo.aggregate(OrgSchema, :count, :id)
  ...
  def show_organization(conn, %{"id" => id}) do
    case TheRobotLearns.Repo.get(OrgSchema, id) do
      nil ->
        conn |> put_status(:not_found) |> json(%{error: "Organization not found"})

      org ->
        members = TheRobotLearns.Organizations.list_members(org.id)
