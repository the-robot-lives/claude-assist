defmodule TheRobotLearnsWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case TheRobotLearns.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%TheRobotLearns.Users.Sessions.UserSession{} = session) do
