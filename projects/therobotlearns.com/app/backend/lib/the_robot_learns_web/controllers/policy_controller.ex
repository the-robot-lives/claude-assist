defmodule TheRobotLearnsWeb.PolicyController do
  use TheRobotLearnsWeb, :controller

  alias TheRobotLearns.Authz
  alias TheRobotLearns.Authz.Policies
  ...
  def show(conn, %{"id" => id}) do
    case TheRobotLearns.Repo.get(TheRobotLearns.Schema.Authz.Policy, id) do
