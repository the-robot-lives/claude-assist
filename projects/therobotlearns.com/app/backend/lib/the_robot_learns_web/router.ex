defmodule TheRobotLearnsWeb.Router do
  use TheRobotLearnsWeb, :router
  ...
  pipeline :authenticated do
    plug TheRobotLearnsWeb.AuthPipeline
  end
  ...
  pipeline :rate_limited_auth do
    plug TheRobotLearnsWeb.Plugs.RateLimit, action: :auth
  end

  pipeline :rate_limited_sensitive do
    plug TheRobotLearnsWeb.Plugs.RateLimit, action: :auth_sensitive
  end

  pipeline :org_viewer do
    plug TheRobotLearnsWeb.Plugs.RequireRole, role: "viewer"
  end

  pipeline :org_editor do
    plug TheRobotLearnsWeb.Plugs.RequireRole, role: "editor"
  end

  pipeline :org_admin do
    plug TheRobotLearnsWeb.Plugs.RequireRole, role: "admin"
  end

  pipeline :org_owner do
    plug TheRobotLearnsWeb.Plugs.RequireRole, role: "owner"
  end

  pipeline :admin do
    plug TheRobotLearnsWeb.Plugs.RequireAdmin
  end

  scope "/", TheRobotLearnsWeb do
    pipe_through :api
    get "/health", HealthController, :index
  end

  scope "/api/v1", TheRobotLearnsWeb do
  ...
  scope "/media", TheRobotLearnsWeb do
    pipe_through [:api]
  ...
  # OIDC redirect flow
  scope "/auth/oidc", TheRobotLearnsWeb do
    pipe_through [:sso_session]
  ...
  scope "/auth", TheRobotLearnsWeb do
    pipe_through [:sso_session]
  ...
  if Application.compile_env(:the_robot_learns, :dev_routes) do
    import Phoenix.LiveDashboard.Router

    scope "/dev" do
      pipe_through [:fetch_session, :protect_from_forgery]
      live_dashboard "/dashboard", metrics: TheRobotLearnsWeb.Telemetry
    end
  end
end
