defmodule TheRobotLearns.Users.Sessions do
  @moduledoc """
  Context for TheRobotLearns.Users.Sessions
  """
  alias TheRobotLearns.Users.Sessions.UserSession, as: Entity
  alias TheRobotLearns.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: TheRobotLearns.Users.Sessions.UserSession)
