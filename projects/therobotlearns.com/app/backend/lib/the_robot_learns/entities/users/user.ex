defmodule TheRobotLearns.Users.User do
  use Noizu.Entities

  @vsn 1.0
  @repo TheRobotLearns.Users
  @sref "user"
  @persistence ecto_store(TheRobotLearns.Schema.Users.User, TheRobotLearns.Repo)
  ...
  def_entity do
    ...
    @config auto: true
    @store name: :name_id
    field :name, nil, TheRobotLearns.Versioned.Names.NameReference
    ...
    field :status, nil, {:ecto, TheRobotLearns.Schema.Users.User.__schema__(:type, :status)}
    ...
    field :invite_token, nil, TheRobotLearns.Organizations.InviteTokenReference

    @config auto: false
    @store name: :approved_by_user_id
    field :approved_by, nil, TheRobotLearns.Users.UserReference
