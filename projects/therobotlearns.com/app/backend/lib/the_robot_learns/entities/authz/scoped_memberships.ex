defmodule TheRobotLearns.Authz.ScopedMemberships do
  alias TheRobotLearns.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias TheRobotLearns.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      on: g.id == sm.group_id,
      join: u in TheRobotLearns.Schema.Users.User,
