defmodule TheRobotLearns.Versioned.Strings do
  alias TheRobotLearns.Versioned.Strings.String, as: Entity
  alias TheRobotLearns.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
