defmodule TheRobotLearns.Versioned.Names do
  alias TheRobotLearns.Versioned.Names.Name, as: Entity
  alias TheRobotLearns.Schema.Versioned.Names.Name, as: Schema
  use Noizu.Repo
