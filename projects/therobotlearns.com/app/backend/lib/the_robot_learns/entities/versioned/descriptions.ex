defmodule TheRobotLearns.Versioned.Descriptions do
  alias TheRobotLearns.Versioned.Descriptions.Description, as: Entity
  alias TheRobotLearns.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
