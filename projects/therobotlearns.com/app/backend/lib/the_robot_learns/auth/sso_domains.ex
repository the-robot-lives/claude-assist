defmodule TheRobotLearns.Auth.SSODomains do
  @moduledoc """
  ...
  def policies do
    explicit = Application.get_env(:the_robot_learns, :sso_domain_policies, %{})
    legacy = Application.get_env(:the_robot_learns, :sso_domains, %{})
    auto_approve = Application.get_env(:the_robot_learns, :sso_auto_approve_domains, [])
