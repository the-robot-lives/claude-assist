defmodule TheRobotLearns.Schema.Users.Credentials.UserCredential do
  use Ecto.Schema
  ...
  schema "user_credentials" do
    ...
    belongs_to :auth_provider, TheRobotLearns.Schema.Auth.Providers.Provider, type: Ecto.UUID
