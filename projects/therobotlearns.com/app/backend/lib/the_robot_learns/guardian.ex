defmodule TheRobotLearns.Guardian do
  use Guardian, otp_app: :the_robot_learns

  def subject_for_token(%TheRobotLearns.Users.Sessions.UserSession{} = session, _claims) do
