...
alias TheRobotLearns.Schema.Organizations.Organization
alias TheRobotLearns.Schema.Organizations.Membership
alias TheRobotLearns.Schema.Organizations.InviteToken
alias TheRobotLearns.Schema.Users.Credentials.UserCredential
alias TheRobotLearns.Schema.Versioned.Names.Name
alias TheRobotLearns.Schema.Versioned.Descriptions.Description

admin_id = UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin")
dev_org_id = UUID.uuid5(:oid, "TheRobotLearns.Dev.Organization")
login_provider_id = UUID.uuid5(:oid, "TheRobotLearns.Schema.Auth.Providers.Provider@Login")

seed "dev:admin-name" do
  TheRobotLearns.Repo.insert!(
    %Name{id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Name"), first: "Admin", last: "User"},
    on_conflict: :nothing,
    conflict_target: :id
  )
end
...
seed "dev:admin-description" do
  TheRobotLearns.Repo.insert!(
    %Description{
      id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Description"),
      title: "Admin",
...
seed "dev:admin-user" do
  TheRobotLearns.Repo.insert!(
    %User{
      ...
      user_name: "admin",
      handle: "admin",
      name_id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Name"),
      description_id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Description"),
...
seed "dev:admin-credential" do
  TheRobotLearns.Repo.insert!(
    %UserCredential{
      id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Credential"),
      user_id: admin_id,
...
seed "dev:admin-membership" do
  TheRobotLearns.Repo.insert!(
    %Membership{
      id: UUID.uuid5(:oid, "TheRobotLearns.Dev.Admin.Membership"),
...
seed "dev:bootstrap-invite" do
  ...
  TheRobotLearns.Repo.insert!(
    %InviteToken{
      id: UUID.uuid5(:oid, "TheRobotLearns.Dev.BootstrapInvite"),
      organization_id: dev_org_id,
...
seed "dev:admin-magic-link-token" do
  admin_ref = TheRobotLearns.Users.User.ref(admin_id)
