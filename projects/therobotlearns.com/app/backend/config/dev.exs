...
config :the_robot_learns, TheRobotLearns.Repo,
  username: System.get_env("DB_USER", "the_robot_learns"),
  password: System.get_env("DB_PASS", "trl_dev"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "trl_dev"),
...
config :the_robot_learns, dev_routes: true

config :the_robot_learns, :frontend_url, "http://localhost:3000"
