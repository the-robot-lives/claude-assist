defmodule GottaCc.Authz.ScopedMemberships do
  alias GottaCc.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias GottaCc.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in GottaCc.Schema.Users.User, on: u.id == sm.member_id,
