defmodule GottaCc.Versioned.Descriptions do
  alias GottaCc.Versioned.Descriptions.Description, as: Entity
  alias GottaCc.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
