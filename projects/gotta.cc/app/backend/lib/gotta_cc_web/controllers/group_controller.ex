defmodule GottaCcWeb.GroupController do
  use GottaCcWeb, :controller

  alias GottaCc.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: GottaCc.Repo.get(GottaCc.Schema.Authz.Group, id), else: Groups.get_by_name(id)
