defmodule GottaCcWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case GottaCc.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%GottaCc.Users.Sessions.UserSession{} = session) do
