defmodule GottaCcWeb.Router do
  use GottaCcWeb, :router
  ...
  pipeline :rate_limited_auth do
    plug GottaCcWeb.Plugs.RateLimit, action: :auth
  end
  ...
  pipeline :org_viewer do
    plug GottaCcWeb.Plugs.RequireRole, role: "viewer"
  end

  pipeline :org_editor do
    plug GottaCcWeb.Plugs.RequireRole, role: "editor"
  end

  pipeline :org_admin do
    plug GottaCcWeb.Plugs.RequireRole, role: "admin"
  end

  pipeline :org_owner do
    plug GottaCcWeb.Plugs.RequireRole, role: "owner"
  end

  pipeline :admin do
    plug GottaCcWeb.Plugs.RequireAdmin
  end
  ...
  scope "/api/v1/admin", GottaCcWeb do
  ...
  if Application.compile_env(:gotta_cc, :saml_enabled) do
    scope "/sso/saml" do
  ...
  if Application.compile_env(:gotta_cc, :dev_routes) do
    import Phoenix.LiveDashboard.Router

    scope "/dev" do
      pipe_through [:fetch_session, :protect_from_forgery]
      live_dashboard "/dashboard", metrics: GottaCcWeb.Telemetry
    end
  end
end
