...
alias GottaCc.Schema.Users.User
alias GottaCc.Schema.Organizations.Organization
alias GottaCc.Schema.Organizations.Membership
alias GottaCc.Schema.Organizations.InviteToken
alias GottaCc.Schema.Users.Credentials.UserCredential
alias GottaCc.Schema.Versioned.Names.Name
alias GottaCc.Schema.Versioned.Descriptions.Description

admin_id = UUID.uuid5(:oid, "GottaCc.Dev.Admin")
...
seed "dev:admin-user" do
  GottaCc.Repo.insert!(
    %User{
      ...
      user_name: "admin",
      handle: "admin",
      name_id: UUID.uuid5(:oid, "GottaCc.Dev.Admin.Name"),
      description_id: UUID.uuid5(:oid, "GottaCc.Dev.Admin.Description"),
      email: "admin@gotta_cc.local",
...
seed "dev:bootstrap-invite" do
  ...
  GottaCc.Repo.insert!(
    %InviteToken{
      id: UUID.uuid5(:oid, "GottaCc.Dev.BootstrapInvite"),
      organization_id: dev_org_id,
