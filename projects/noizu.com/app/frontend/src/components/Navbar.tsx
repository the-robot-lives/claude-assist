      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-14 sm:h-16 items-center justify-between mt-2 rounded-2xl glass px-4 sm:px-6">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button
              onClick={() => startLogin()}
              className="ml-2 px-4 py-2 text-sm text-zinc-300 hover:text-gold-400 transition-colors rounded-lg hover:bg-white/[0.05] font-mono"
            >
              Sign In
            </button>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 text-sm bg-gold-400 hover:bg-gold-300 text-zinc-950 font-medium rounded-lg transition-colors"
            >
              GitHub
            </a>
          </div>
          ...
          {mobileOpen && (
            ...
            >
              ...
              <button
                ...
                className="block w-full mt-2 px-4 py-3 text-sm text-left text-zinc-300 hover:text-gold-400 transition-colors rounded-lg hover:bg-white/[0.05] font-mono"
              >
                Sign In
              </button>
              <a
