defmodule NoizuSite.Versioned.Descriptions do
  alias NoizuSite.Versioned.Descriptions.Description, as: Entity
  alias NoizuSite.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
