defmodule NoizuSite.Authz do
  ...
  def explain_permission(user_id, resource_type, resource_id, action) do
    ...
    if is_nil(role) do
      ...
      NoizuSite.Authz.PolicyEvaluator.evaluate(
  ...
  defp get_effective_policies(user_id, resource_type, resource_id) do
    ...
    case Ecto.Adapters.SQL.query(NoizuSite.Repo, sql, [uuid_to_bin(user_id), resource_type, uuid_to_bin(resource_id)]) do
