defmodule NoizuSite.Users.Sessions do
  @moduledoc """
  Context for NoizuSite.Users.Sessions
  """
  alias NoizuSite.Users.Sessions.UserSession, as: Entity
  alias NoizuSite.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: NoizuSite.Users.Sessions.UserSession)
