defmodule NoizuSite.Authz.ScopedMemberships do
  alias NoizuSite.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias NoizuSite.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in NoizuSite.Schema.Users.User, on: u.id == sm.member_id,
