defmodule NoizuSite.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo NoizuSite.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(NoizuSite.Schema.Organizations.InviteToken, NoizuSite.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, NoizuSite.Users.UserReference
