defmodule NoizuSiteWeb.GroupController do
  use NoizuSiteWeb, :controller

  alias NoizuSite.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: NoizuSite.Repo.get(NoizuSite.Schema.Authz.Group, id), else: Groups.get_by_name(id)
