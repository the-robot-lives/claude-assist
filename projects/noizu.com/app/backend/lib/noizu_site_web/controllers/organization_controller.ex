defmodule NoizuSiteWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case NoizuSite.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%NoizuSite.Users.Sessions.UserSession{} = session) do
