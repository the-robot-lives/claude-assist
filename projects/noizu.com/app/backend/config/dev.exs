...
config :noizu_site, NoizuSite.Repo,
  username: System.get_env("DB_USER", "noizu_site"),
  password: System.get_env("DB_PASS", "noizu_site_dev"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "noizu_site_dev"),
...
config :noizu_site, dev_routes: true

config :noizu_site, :frontend_url, "http://localhost:3000"
