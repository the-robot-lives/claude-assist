...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "AI-powered fighting game",
    group: "Published Sites",
    icon: "\u{1F94A}",
    status: "active",
    tags: ["game", "ai", "fighting", "public"],
  },
  {
    slug: "blade-of-eternity",
    name: "Blade of Eternity",
    domain: "bladeofeternity.com",
    description: "RPG game project",
    group: "Published Sites",
    icon: "\u{2694}\u{FE0F}",
    status: "active",
    tags: ["game", "rpg", "public"],
  },
  {
    slug: "codefresh",
    name: "CodeFre.sh",
  ...
  },
  {
    ...
    icon: "\u{1F517}",
    status: "active",
    tags: ["links", "shortener", "public"],
  },
  {
    slug: "iotgo",
    name: "IoTGo",
    domain: "iotgo.io",
    description: "IoT platform and services",
    group: "Published Sites",
    icon: "\u{1F4E1}",
    status: "active",
    tags: ["iot", "devices", "platform", "public"],
  },
  {
    slug: "jailbreakingsite",
    name: "Jailbreaking Site",
    domain: "jailbreakingsite.com",
    description: "Jailbreaking resources and community",
    group: "Published Sites",
    icon: "\u{1F513}",
    status: "active",
    tags: ["jailbreak", "community", "public"],
  },
  {
    slug: "tobor-locker",
    name: "Tobor Locker",
    domain: "tobor.locker",
    description: "Digital asset locker",
    group: "Published Sites",
    icon: "\u{1F512}",
    status: "active",
    tags: ["assets", "locker", "storage", "public"],
  },
  {
    slug: "noizurpg",
    name: "Noizu RPG",
    domain: "noizurpg.com",
    description: "Tabletop RPG platform",
    group: "Published Sites",
    icon: "\u{1F3B2}",
    status: "active",
    tags: ["rpg", "tabletop", "game", "public"],
  },
  {
    slug: "robots-unit",
    name: "Robots Unit",
    domain: "robots-unit.com",
    description: "Robotics and automation collective",
    group: "Published Sites",
    icon: "\u{1F916}",
    status: "active",
    tags: ["robots", "automation", "collective", "public"],
  },
  {
    slug: "therobotknows",
    name: "The Robot Knows",
    domain: "therobotknows.com",
    description: "AI knowledge and insights",
    group: "Published Sites",
    icon: "\u{1F9E0}",
    status: "active",
    tags: ["ai", "knowledge", "blog", "public"],
  },
  {
    slug: "therobotlives",
    name: "The Robot Lives",
    domain: "therobotlives.com",
    description: "Robot lifestyle and culture",
    group: "Published Sites",
    icon: "\u{1F4AB}",
    status: "active",
    tags: ["robot", "lifestyle", "culture", "public"],
  },
  {
    slug: "therobotmakes",
    name: "The Robot Makes",
    domain: "therobotmakes.com",
    description: "Creative projects and maker content",
    group: "Published Sites",
    icon: "\u{1F528}",
    status: "active",
    tags: ["maker", "creative", "projects", "public"],
  },
  {
    slug: "therobotlearns",
    name: "The Robot Learns",
    domain: "therobotlearns.com",
    description: "Educational content and tutorials",
    group: "Published Sites",
    icon: "\u{1F393}",
    status: "active",
    tags: ["education", "tutorials", "learning", "public"],
  },
