// Domain → descriptor registry. DetailView resolves a related collection's
// descriptor by its domain key to render an embedded read-only mini DataTable.
// Per-domain generics are erased to ConsoleDescriptor<any, any> at this seam (the
// registry is heterogeneous by nature); call sites stay typed.
/* eslint-disable @typescript-eslint/no-explicit-any */
import type { ConsoleDescriptor } from "./types";
import { itemsDescriptor, boardsDescriptor } from "./descriptors";
