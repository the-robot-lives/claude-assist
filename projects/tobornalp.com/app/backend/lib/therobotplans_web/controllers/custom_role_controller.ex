defmodule TherobotplansWeb.CustomRoleController do
  use TherobotplansWeb, :controller

  alias Therobotplans.Schema.Organizations.CustomRole, as: RoleSchema
  alias Therobotplans.Schema.Organizations.CustomRolePermission, as: PermSchema
