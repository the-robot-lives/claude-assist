defmodule TherobotplansWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Therobotplans.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Therobotplans.Users.Sessions.UserSession{} = session) do
