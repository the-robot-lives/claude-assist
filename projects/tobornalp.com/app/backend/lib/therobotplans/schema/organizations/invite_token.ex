defmodule Therobotplans.Schema.Organizations.InviteToken do
  use Ecto.Schema
  ...
  schema "invite_tokens" do
    ...
    belongs_to :created_by_user, Therobotplans.Schema.Users.User, type: Ecto.UUID
    ...
    belongs_to :accepted_by_user, Therobotplans.Schema.Users.User,
