defmodule Therobotplans.Schema.Watch do
  use Ecto.Schema
  ...
  # Generic per-entity watch keyed by (entity_type, entity_id). `persona` is the
  # watcher (a user id). Ported from NPL Schema.Watch.
  schema "trp_watches" do
