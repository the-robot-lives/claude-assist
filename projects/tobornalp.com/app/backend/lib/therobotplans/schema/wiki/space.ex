defmodule Therobotplans.Schema.Wiki.Space do
  @moduledoc """
  A wiki space: org-required, project-optional. Groups wiki pages. Ported from
  NPL Schema.Wiki.Space.
  """
  use Ecto.Schema
  ...
  schema "wiki_spaces" do
    ...
    has_many :pages, Therobotplans.Schema.Wiki.Page
