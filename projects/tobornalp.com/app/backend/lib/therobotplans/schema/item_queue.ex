defmodule Therobotplans.Schema.ItemQueue do
  @moduledoc """
  ...
  schema "item_queues" do
    ...
    has_many :stages, Therobotplans.Schema.BoardStage, foreign_key: :queue_id
    has_many :iterations, Therobotplans.Schema.BoardIteration, foreign_key: :queue_id
