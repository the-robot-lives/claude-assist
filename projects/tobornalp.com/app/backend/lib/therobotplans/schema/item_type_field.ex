defmodule Therobotplans.Schema.ItemTypeField do
  use Ecto.Schema
  ...
  schema "item_type_fields" do
    belongs_to :item_type_definition, Therobotplans.Schema.ItemTypeDefinition
    belongs_to :item_field_definition, Therobotplans.Schema.ItemFieldDefinition
