defmodule Therobotplans.Domains.Items.Queues do
  @moduledoc """
  Boards (a.k.a. "queues") and their stages and iterations. A board carries a
  ...
  alias Therobotplans.Schema.{ItemQueue, BoardStage, BoardIteration, Item}
  ...
  def create(attrs) do
    Repo.transaction(fn ->
      with {:ok, board} <- %ItemQueue{} |> ItemQueue.changeset(attrs) |> Repo.insert() do
