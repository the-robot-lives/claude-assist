defmodule Therobotplans.Domains.Items.Tools.DefinitionGet do
  use Noizu.MCP.Server.Tool,
    name: "Item.Definition.Get",
    description: "Get an item type definition by slug, including its fields and status workflow.",
    hidden: true,
  ...
  input do
    ...
    field :slug, :string, required: true, description: "Item type slug (e.g. \"bug\", \"epic\")"
  end
  ...
  def call(args, _ctx) do
    ...
    with {:ok, org_id, project_id} <-
      ...
      nil -> {:error, "Item type '#{slug}' not found"}
