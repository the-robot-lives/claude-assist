defmodule Therobotplans.Domains.Items.Tools.ItemLinkEntity do
  use Noizu.MCP.Server.Tool,
    ...
    description:
      "Link an item to a non-item entity (customer_persona, customer_segment, campaign, keyword, competitor, market_report, landing_page, domain_name, ad_group, ad_copy).",
    hidden: true,
    category: "Items"
