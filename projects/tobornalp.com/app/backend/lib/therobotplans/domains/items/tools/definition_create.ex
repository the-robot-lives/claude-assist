defmodule Therobotplans.Domains.Items.Tools.DefinitionCreate do
  use Noizu.MCP.Server.Tool,
    name: "Item.Definition.Create",
    description: "Define an item type with custom field schema and status workflow.",
    hidden: true,
