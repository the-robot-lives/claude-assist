defmodule Therobotplans.Domains.Items.Tools.FieldDefinitionCreate do
  use Noizu.MCP.Server.Tool,
    name: "Item.Field.Definition.Create",
    description: "Define a custom field type for use in item type definitions.",
    hidden: true,
