defmodule Therobotplans.Domains.Artifacts do
  @moduledoc """
  Versioned typed-content objects (code/document/image/wiki/config/binary).
  Org-required, project-optional. Each artifact has an append-only revision
  history; the latest revision is the current content.
  """
  import Ecto.Query, except: [update: 2]
  alias Therobotplans.Repo
  alias Therobotplans.Schema.{Artifact, ArtifactRevision}
