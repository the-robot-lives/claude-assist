defmodule Therobotplans.Services.Watch do
  @moduledoc """
  Generic per-entity watches keyed by (entity_type, entity_id). `persona` is the
  watcher (a user id). An optional `filter` restricts which updates fire a
  notification. Ported from NPL Services.Watch.
  """
  import Ecto.Query

  alias Therobotplans.Repo
  alias Therobotplans.Schema.Watch
