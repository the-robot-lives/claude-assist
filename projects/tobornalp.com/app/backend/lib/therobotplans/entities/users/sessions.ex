defmodule Therobotplans.Users.Sessions do
  @moduledoc """
  Context for Therobotplans.Users.Sessions
  """
  alias Therobotplans.Users.Sessions.UserSession, as: Entity
  alias Therobotplans.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Therobotplans.Users.Sessions.UserSession)
