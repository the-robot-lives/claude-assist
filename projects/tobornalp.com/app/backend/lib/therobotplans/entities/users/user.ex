defmodule Therobotplans.Users.User do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotplans.Users
  @sref "user"
  @persistence ecto_store(Therobotplans.Schema.Users.User, Therobotplans.Repo)
  ...
  def_entity do
    ...
    @config auto: true
    @store name: :name_id
    field :name, nil, Therobotplans.Versioned.Names.NameReference
    ...
    field :status, nil, {:ecto, Therobotplans.Schema.Users.User.__schema__(:type, :status)}
    ...
    field :invite_token, nil, Therobotplans.Organizations.InviteTokenReference

    @config auto: false
    @store name: :approved_by_user_id
    field :approved_by, nil, Therobotplans.Users.UserReference
