defmodule Therobotplans.Users.Credentials.UserCredential do
  ...
  @persistence ecto_store(Therobotplans.Schema.Users.Credentials.UserCredential, Therobotplans.Repo)
  ...
  def_entity do
    ...
    field :status, nil,
          {:ecto, Therobotplans.Schema.Users.Credentials.UserCredential.__schema__(:type, :status)}
    field :settings, %{}, :map
    field :state, %{}, :map
