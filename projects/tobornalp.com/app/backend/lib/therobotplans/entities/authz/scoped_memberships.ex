defmodule Therobotplans.Authz.ScopedMemberships do
  alias Therobotplans.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Therobotplans.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      join: g in Therobotplans.Schema.Authz.Group, on: g.id == sm.group_id,
      join: u in Therobotplans.Schema.Users.User, on: u.id == sm.member_id,
