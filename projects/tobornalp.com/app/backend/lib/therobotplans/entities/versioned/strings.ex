defmodule Therobotplans.Versioned.Strings do
  alias Therobotplans.Versioned.Strings.String, as: Entity
  alias Therobotplans.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
