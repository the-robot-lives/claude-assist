defmodule Therobotplans.Versioned.Descriptions do
  alias Therobotplans.Versioned.Descriptions.Description, as: Entity
  alias Therobotplans.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
