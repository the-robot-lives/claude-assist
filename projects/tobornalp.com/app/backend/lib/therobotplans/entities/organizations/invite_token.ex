defmodule Therobotplans.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotplans.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Therobotplans.Schema.Organizations.InviteToken, Therobotplans.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Therobotplans.Users.UserReference
