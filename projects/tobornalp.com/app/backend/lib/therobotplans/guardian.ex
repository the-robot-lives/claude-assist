defmodule Therobotplans.Guardian do
  use Guardian, otp_app: :therobotplans

  def subject_for_token(%Therobotplans.Users.Sessions.UserSession{} = session, _claims) do
