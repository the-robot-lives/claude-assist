defmodule Therobotplans.Events do
  require Logger
  ...
  def dispatch(event_type, payload) when event_type in @type_list do
    ...
    Phoenix.PubSub.broadcast(Therobotplans.PubSub, "events", {event_type, payload})
  end
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Therobotplans.PubSub, "events")
  end
end
