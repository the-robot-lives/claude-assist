...
if System.get_env("PHX_SERVER") do
  config :therobotplans, TherobotplansWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :therobotplans, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  if s3_bucket = System.get_env("S3_BUCKET") do
    config :therobotplans, Therobotplans.Storage,
      bucket: s3_bucket,
  ...
  #     config :therobotplans, :linkedin_enabled, true
