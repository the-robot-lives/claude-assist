...
config :therobotknows, Therobotknows.Repo,
  username: System.get_env("DB_USER", "therobotknows"),
  password: System.get_env("DB_PASS", "therobotknows_dev"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "therobotknows_dev"),
...
config :therobotknows, dev_routes: true

config :therobotknows, :frontend_url, "http://localhost:3000"
