defmodule TherobotknowsWeb.Plugs.RequireAdmin do
  @behaviour Plug
  import Plug.Conn
  ...
  defp get_user(conn) do
    case Therobotknows.Guardian.Plug.current_resource(conn) do
      %Therobotknows.Users.Sessions.UserSession{user: {:ref, _, id}} ->
        case Therobotknows.Repo.get(Therobotknows.Schema.Users.User, id) do
          nil -> :error
          user -> {:ok, user}
        end

      %Therobotknows.Users.Sessions.UserSession{user: %{id: id}} ->
        case Therobotknows.Repo.get(Therobotknows.Schema.Users.User, id) do
          nil -> :error
          user -> {:ok, user}
        end
