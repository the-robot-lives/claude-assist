defmodule TherobotknowsWeb.GroupController do
  use TherobotknowsWeb, :controller

  alias Therobotknows.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Therobotknows.Repo.get(Therobotknows.Schema.Authz.Group, id), else: Groups.get_by_name(id)
