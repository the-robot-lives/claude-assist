defmodule TherobotknowsWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Therobotknows.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Therobotknows.Users.Sessions.UserSession{} = session) do
