defmodule Therobotknows.Guardian do
  use Guardian, otp_app: :therobotknows

  def subject_for_token(%Therobotknows.Users.Sessions.UserSession{} = session, _claims) do
