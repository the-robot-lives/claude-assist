defmodule Therobotknows.Authz.ScopedMemberships do
  alias Therobotknows.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Therobotknows.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Therobotknows.Schema.Users.User, on: u.id == sm.member_id,
