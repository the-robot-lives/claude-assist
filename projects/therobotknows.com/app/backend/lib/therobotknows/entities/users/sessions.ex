defmodule Therobotknows.Users.Sessions do
  @moduledoc """
  Context for Therobotknows.Users.Sessions
  """
  alias Therobotknows.Users.Sessions.UserSession, as: Entity
  alias Therobotknows.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Therobotknows.Users.Sessions.UserSession)
