defmodule Therobotknows.Versioned.Strings do
  alias Therobotknows.Versioned.Strings.String, as: Entity
  alias Therobotknows.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
