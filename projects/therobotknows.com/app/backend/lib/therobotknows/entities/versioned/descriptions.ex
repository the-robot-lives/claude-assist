defmodule Therobotknows.Versioned.Descriptions do
  alias Therobotknows.Versioned.Descriptions.Description, as: Entity
  alias Therobotknows.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
