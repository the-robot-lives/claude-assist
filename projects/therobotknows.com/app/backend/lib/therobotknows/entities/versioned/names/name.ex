defmodule Therobotknows.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotknows.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Therobotknows.Schema.Versioned.Names.Name, Therobotknows.Repo)
