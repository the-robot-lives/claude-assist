defmodule Therobotknows.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotknows.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Therobotknows.Schema.Organizations.InviteToken, Therobotknows.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Therobotknows.Users.UserReference
