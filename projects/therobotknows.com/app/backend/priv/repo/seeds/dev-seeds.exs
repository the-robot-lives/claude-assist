...
alias Therobotknows.Schema.Users.User
alias Therobotknows.Schema.Organizations.Organization
alias Therobotknows.Schema.Organizations.Membership
alias Therobotknows.Schema.Organizations.InviteToken
alias Therobotknows.Schema.Users.Credentials.UserCredential
alias Therobotknows.Schema.Versioned.Names.Name
alias Therobotknows.Schema.Versioned.Descriptions.Description

admin_id = UUID.uuid5(:oid, "Therobotknows.Dev.Admin")
dev_org_id = UUID.uuid5(:oid, "Therobotknows.Dev.Organization")
login_provider_id = UUID.uuid5(:oid, "Therobotknows.Schema.Auth.Providers.Provider@Login")

seed "dev:admin-name" do
  Therobotknows.Repo.insert!(
    %Name{id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Name"), first: "Admin", last: "User"},
    on_conflict: :nothing,
    conflict_target: :id
  )
end
...
seed "dev:admin-description" do
  Therobotknows.Repo.insert!(
    %Description{
      id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Description"),
      title: "Admin",
...
seed "dev:admin-user" do
  Therobotknows.Repo.insert!(
    %User{
      ...
      user_name: "admin",
      handle: "admin",
      name_id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Name"),
      description_id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Description"),
      email: "admin@therobotknows.local",
...
seed "dev:admin-credential" do
  Therobotknows.Repo.insert!(
    %UserCredential{
      id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Credential"),
      user_id: admin_id,
...
seed "dev:admin-membership" do
  Therobotknows.Repo.insert!(
    %Membership{
      id: UUID.uuid5(:oid, "Therobotknows.Dev.Admin.Membership"),
...
seed "dev:bootstrap-invite" do
  ...
  Therobotknows.Repo.insert!(
    %InviteToken{
      id: UUID.uuid5(:oid, "Therobotknows.Dev.BootstrapInvite"),
      organization_id: dev_org_id,
...
seed "dev:admin-magic-link-token" do
  admin_ref = Therobotknows.Users.User.ref(admin_id)
