defmodule Foryou.Schema.Authz.Policy do
  use Ecto.Schema
  ...
  schema "policies" do
    ...
    belongs_to :created_by_user, Foryou.Schema.Users.User, type: Ecto.UUID, foreign_key: :created_by

    has_many :group_policies, Foryou.Schema.Authz.GroupPolicy
