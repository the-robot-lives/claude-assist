defmodule Foryou.Schema.Users.Credentials.UserCredential do
  use Ecto.Schema
  ...
  schema "user_credentials" do
    ...
    belongs_to :auth_provider, Foryou.Schema.Auth.Providers.Provider, type: Ecto.UUID
    belongs_to :description, Foryou.Schema.Versioned.Descriptions.Description, type: Ecto.UUID
