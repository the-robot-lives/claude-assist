defmodule Foryou.Authz.ScopedMemberships do
  alias Foryou.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Foryou.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Foryou.Schema.Users.User, on: u.id == sm.member_id,
