defmodule Foryou.Versioned.Descriptions do
  alias Foryou.Versioned.Descriptions.Description, as: Entity
  alias Foryou.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
