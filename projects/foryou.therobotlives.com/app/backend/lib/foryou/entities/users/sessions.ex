defmodule Foryou.Users.Sessions do
  @moduledoc """
  Context for Foryou.Users.Sessions
  """
  alias Foryou.Users.Sessions.UserSession, as: Entity
  alias Foryou.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Foryou.Users.Sessions.UserSession)
