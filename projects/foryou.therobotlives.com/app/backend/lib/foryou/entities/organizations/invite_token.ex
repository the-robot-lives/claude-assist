defmodule Foryou.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Foryou.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Foryou.Schema.Organizations.InviteToken, Foryou.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Foryou.Users.UserReference
