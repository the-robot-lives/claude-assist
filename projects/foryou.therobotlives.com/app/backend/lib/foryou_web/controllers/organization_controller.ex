defmodule ForyouWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Foryou.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Foryou.Users.Sessions.UserSession{} = session) do
