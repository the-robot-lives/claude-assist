defmodule ForyouWeb.GroupController do
  use ForyouWeb, :controller

  alias Foryou.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Foryou.Repo.get(Foryou.Schema.Authz.Group, id), else: Groups.get_by_name(id)
