defmodule TherobotlivesWeb.GroupController do
  use TherobotlivesWeb, :controller

  alias Therobotlives.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Therobotlives.Repo.get(Therobotlives.Schema.Authz.Group, id), else: Groups.get_by_name(id)
