defmodule Therobotlives.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotlives.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Therobotlives.Schema.Organizations.InviteToken, Therobotlives.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Therobotlives.Users.UserReference
