defmodule Therobotlives.Users.Sessions do
  @moduledoc """
  Context for Therobotlives.Users.Sessions
  """
  alias Therobotlives.Users.Sessions.UserSession, as: Entity
  alias Therobotlives.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Therobotlives.Users.Sessions.UserSession)
