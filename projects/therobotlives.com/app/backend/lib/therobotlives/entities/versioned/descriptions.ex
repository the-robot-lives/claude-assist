defmodule Therobotlives.Versioned.Descriptions do
  alias Therobotlives.Versioned.Descriptions.Description, as: Entity
  alias Therobotlives.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
