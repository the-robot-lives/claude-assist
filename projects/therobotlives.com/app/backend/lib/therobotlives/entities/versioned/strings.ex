defmodule Therobotlives.Versioned.Strings do
  alias Therobotlives.Versioned.Strings.String, as: Entity
  alias Therobotlives.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
