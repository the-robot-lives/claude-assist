defmodule Therobotlives.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotlives.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Therobotlives.Schema.Versioned.Names.Name, Therobotlives.Repo)
