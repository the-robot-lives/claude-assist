defmodule Therobotlives.Authz.ScopedMemberships do
  alias Therobotlives.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Therobotlives.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Therobotlives.Schema.Users.User, on: u.id == sm.member_id,
