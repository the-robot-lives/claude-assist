defmodule Therobotlives.Guardian do
  use Guardian, otp_app: :therobotlives

  def subject_for_token(%Therobotlives.Users.Sessions.UserSession{} = session, _claims) do
