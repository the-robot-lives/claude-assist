...
config :aifighter, Aifighter.Repo,
  username: System.get_env("DB_USER", "aifighter"),
  password: System.get_env("DB_PASS", "aifighter_dev"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "aifighter_dev"),
...
config :aifighter, dev_routes: true

config :aifighter, :frontend_url, "http://localhost:3000"
