defmodule Aifighter.Users.User do
  use Noizu.Entities

  @vsn 1.0
  @repo Aifighter.Users
  @sref "user"
  @persistence ecto_store(Aifighter.Schema.Users.User, Aifighter.Repo)
  ...
  def_entity do
    ...
    @config auto: true
    @store name: :name_id
    field :name, nil, Aifighter.Versioned.Names.NameReference
    ...
    field :status, nil, {:ecto, Aifighter.Schema.Users.User.__schema__(:type, :status)}
