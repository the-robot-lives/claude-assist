defmodule Aifighter.Users.Sessions do
  @moduledoc """
  Context for Aifighter.Users.Sessions
  """
  alias Aifighter.Users.Sessions.UserSession, as: Entity
  alias Aifighter.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Aifighter.Users.Sessions.UserSession)
