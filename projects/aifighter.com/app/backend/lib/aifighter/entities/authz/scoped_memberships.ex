defmodule Aifighter.Authz.ScopedMemberships do
  alias Aifighter.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Aifighter.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Aifighter.Schema.Users.User, on: u.id == sm.member_id,
