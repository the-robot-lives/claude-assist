defmodule Aifighter.Versioned.Descriptions do
  alias Aifighter.Versioned.Descriptions.Description, as: Entity
  alias Aifighter.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
