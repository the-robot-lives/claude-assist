defmodule Aifighter.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Aifighter.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Aifighter.Schema.Organizations.InviteToken, Aifighter.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Aifighter.Users.UserReference
