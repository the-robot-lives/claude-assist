defmodule AifighterWeb.Router do
  use AifighterWeb, :router
  ...
  pipeline :authenticated do
    plug AifighterWeb.AuthPipeline
  end
  ...
  pipeline :rate_limited_auth do
    plug AifighterWeb.Plugs.RateLimit, action: :auth
  end

  pipeline :rate_limited_sensitive do
    plug AifighterWeb.Plugs.RateLimit, action: :auth_sensitive
  end

  pipeline :org_viewer do
    plug AifighterWeb.Plugs.RequireRole, role: "viewer"
  end

  pipeline :org_editor do
    plug AifighterWeb.Plugs.RequireRole, role: "editor"
  end

  pipeline :org_admin do
    plug AifighterWeb.Plugs.RequireRole, role: "admin"
  end

  pipeline :org_owner do
    plug AifighterWeb.Plugs.RequireRole, role: "owner"
  end

  pipeline :admin do
    plug AifighterWeb.Plugs.RequireAdmin
  end

  scope "/", AifighterWeb do
    pipe_through :api
    get "/health", HealthController, :index
  end

  scope "/api/v1", AifighterWeb do
  ...
  if Application.compile_env(:aifighter, :saml_enabled) do
    scope "/sso/saml" do
  ...
  # OIDC redirect flow
  scope "/auth/oidc", AifighterWeb do
    pipe_through [:sso_session]
  ...
  if Application.compile_env(:aifighter, :dev_routes) do
    import Phoenix.LiveDashboard.Router

    scope "/dev" do
      pipe_through [:fetch_session, :protect_from_forgery]
      live_dashboard "/dashboard", metrics: AifighterWeb.Telemetry
    end
  end
end
