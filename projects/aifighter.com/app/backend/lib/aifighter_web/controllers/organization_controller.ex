defmodule AifighterWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Aifighter.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Aifighter.Users.Sessions.UserSession{} = session) do
