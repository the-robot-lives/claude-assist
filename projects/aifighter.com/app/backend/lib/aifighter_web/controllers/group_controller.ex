defmodule AifighterWeb.GroupController do
  use AifighterWeb, :controller

  alias Aifighter.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Aifighter.Repo.get(Aifighter.Schema.Authz.Group, id), else: Groups.get_by_name(id)
