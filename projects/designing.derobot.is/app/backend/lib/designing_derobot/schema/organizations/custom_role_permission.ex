defmodule DesigningDerobot.Schema.Organizations.CustomRolePermission do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:id, Ecto.UUID, autogenerate: true}
  schema "custom_role_permissions" do
    belongs_to :role, DesigningDerobot.Schema.Organizations.CustomRole, type: Ecto.UUID
