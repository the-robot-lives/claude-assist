defmodule DesigningDerobot.Schema.Projects.Project do
  use Ecto.Schema
  ...
  schema "projects" do
    ...
    belongs_to :created_by_user, DesigningDerobot.Schema.Users.User, type: Ecto.UUID, foreign_key: :created_by
