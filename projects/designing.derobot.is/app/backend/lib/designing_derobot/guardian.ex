defmodule DesigningDerobot.Guardian do
  use Guardian, otp_app: :designing_derobot

  def subject_for_token(%DesigningDerobot.Users.Sessions.UserSession{} = session, _claims) do
