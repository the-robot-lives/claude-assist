defmodule DesigningDerobot.Authz.ScopedMemberships do
  alias DesigningDerobot.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias DesigningDerobot.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in DesigningDerobot.Schema.Users.User, on: u.id == sm.member_id,
