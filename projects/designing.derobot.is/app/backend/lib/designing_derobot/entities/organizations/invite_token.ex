defmodule DesigningDerobot.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo DesigningDerobot.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(DesigningDerobot.Schema.Organizations.InviteToken, DesigningDerobot.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, DesigningDerobot.Users.UserReference
