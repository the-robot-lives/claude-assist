defmodule DesigningDerobot.Users.Sessions do
  @moduledoc """
  Context for DesigningDerobot.Users.Sessions
  """
  alias DesigningDerobot.Users.Sessions.UserSession, as: Entity
  alias DesigningDerobot.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: DesigningDerobot.Users.Sessions.UserSession)
