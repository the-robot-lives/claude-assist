defmodule DesigningDerobot.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo DesigningDerobot.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(DesigningDerobot.Schema.Versioned.Names.Name, DesigningDerobot.Repo)
