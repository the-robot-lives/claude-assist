defmodule DesigningDerobot.Versioned.Strings do
  alias DesigningDerobot.Versioned.Strings.String, as: Entity
  alias DesigningDerobot.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
