defmodule DesigningDerobot.Versioned.Names do
  alias DesigningDerobot.Versioned.Names.Name, as: Entity
  alias DesigningDerobot.Schema.Versioned.Names.Name, as: Schema
  use Noizu.Repo
