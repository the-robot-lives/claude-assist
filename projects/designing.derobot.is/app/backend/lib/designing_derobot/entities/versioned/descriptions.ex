defmodule DesigningDerobot.Versioned.Descriptions do
  alias DesigningDerobot.Versioned.Descriptions.Description, as: Entity
  alias DesigningDerobot.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
