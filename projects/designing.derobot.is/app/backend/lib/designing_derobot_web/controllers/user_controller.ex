defmodule DesigningDerobotWeb.UserController do
  use DesigningDerobotWeb, :controller

  alias DesigningDerobot.Guardian
  alias DesigningDerobot.Users
  ...
  defp get_current_user(conn) do
    ...
    case session.user do
      ...
      %DesigningDerobot.Users.User{} = user ->
        user
    end
  end
  ...
  defp validate_update_params(user, params) do
    if params["new_password"] && params["current_password"] do
      ...
      q =
        from c in DesigningDerobot.Schema.Users.Credentials.UserCredential,
  ...
  defp apply_updates(user, params, _context) do
    ...
    if map_size(updates) > 0 do
      ...
      |> DesigningDerobot.Repo.update_all(set: Enum.to_list(updates))
    end

    if params["new_password"] do
      DesigningDerobot.Users.Credentials.update_password(user, params["new_password"], Noizu.Context.system())
    end
