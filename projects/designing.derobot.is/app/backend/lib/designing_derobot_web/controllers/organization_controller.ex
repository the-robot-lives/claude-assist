defmodule DesigningDerobotWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case DesigningDerobot.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%DesigningDerobot.Users.Sessions.UserSession{} = session) do
