defmodule DesigningDerobotWeb.PolicyController do
  use DesigningDerobotWeb, :controller

  alias DesigningDerobot.Authz
  alias DesigningDerobot.Authz.Policies
  ...
  def show(conn, %{"id" => id}) do
    case DesigningDerobot.Repo.get(DesigningDerobot.Schema.Authz.Policy, id) do
