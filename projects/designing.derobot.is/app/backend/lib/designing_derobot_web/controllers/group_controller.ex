defmodule DesigningDerobotWeb.GroupController do
  use DesigningDerobotWeb, :controller

  alias DesigningDerobot.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: DesigningDerobot.Repo.get(DesigningDerobot.Schema.Authz.Group, id), else: Groups.get_by_name(id)
