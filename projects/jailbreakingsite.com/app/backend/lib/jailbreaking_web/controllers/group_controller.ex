defmodule JailbreakingWeb.GroupController do
  use JailbreakingWeb, :controller

  alias Jailbreaking.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Jailbreaking.Repo.get(Jailbreaking.Schema.Authz.Group, id), else: Groups.get_by_name(id)
