defmodule JailbreakingWeb.AuthzMembershipController do
  use JailbreakingWeb, :controller

  alias Jailbreaking.Authz.ScopedMemberships
  ...
  def org_members(conn, %{"org_id" => org_id}) do
    ...
    case Jailbreaking.Authz.authorize(user_id, "organization", org_id, "viewer") do
      {:ok, _} ->
  ...
  def project_members(conn, %{"project_id" => project_id}) do
    ...
    if Jailbreaking.Authz.check_permission(user_id, "project", project_id, "project:view") do
