defmodule JailbreakingWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Jailbreaking.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Jailbreaking.Users.Sessions.UserSession{} = session) do
