defmodule Jailbreaking.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Jailbreaking.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Jailbreaking.Schema.Versioned.Names.Name, Jailbreaking.Repo)
