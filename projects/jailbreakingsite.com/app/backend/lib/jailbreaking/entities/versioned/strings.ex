defmodule Jailbreaking.Versioned.Strings do
  alias Jailbreaking.Versioned.Strings.String, as: Entity
  alias Jailbreaking.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
