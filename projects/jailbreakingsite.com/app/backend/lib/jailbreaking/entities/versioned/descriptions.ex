defmodule Jailbreaking.Versioned.Descriptions do
  alias Jailbreaking.Versioned.Descriptions.Description, as: Entity
  alias Jailbreaking.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
