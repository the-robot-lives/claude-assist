defmodule Jailbreaking.Users.Sessions do
  @moduledoc """
  Context for Jailbreaking.Users.Sessions
  """
  alias Jailbreaking.Users.Sessions.UserSession, as: Entity
  alias Jailbreaking.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Jailbreaking.Users.Sessions.UserSession)
