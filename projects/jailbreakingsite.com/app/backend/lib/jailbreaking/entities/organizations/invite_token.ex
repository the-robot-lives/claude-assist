defmodule Jailbreaking.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Jailbreaking.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Jailbreaking.Schema.Organizations.InviteToken, Jailbreaking.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Jailbreaking.Users.UserReference
