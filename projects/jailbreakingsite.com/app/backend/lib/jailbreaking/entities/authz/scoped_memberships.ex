defmodule Jailbreaking.Authz.ScopedMemberships do
  alias Jailbreaking.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Jailbreaking.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Jailbreaking.Schema.Users.User, on: u.id == sm.member_id,
