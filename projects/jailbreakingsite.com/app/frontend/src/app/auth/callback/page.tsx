  ...
  if (error) {
    return (
      <div className="text-center">
        <p className="font-sans text-sm text-critical mb-4">{error}</p>
        <a
          href="/"
          className="font-mono text-[11px] uppercase tracking-widest text-accent hover:text-accent-hover transition-colors"
        >
          Back to home
        </a>
      </div>
