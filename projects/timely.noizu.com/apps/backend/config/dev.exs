...
config :timely, Timely.Repo,
  ...
  database: System.get_env("DB_NAME", "timely_dev"),
...
config :timely, dev_routes: true

# Public app URL — Hologram UI is served by this Phoenix app (same host/port).
config :timely, :frontend_url, System.get_env("FRONTEND_URL", "http://localhost:5585")
