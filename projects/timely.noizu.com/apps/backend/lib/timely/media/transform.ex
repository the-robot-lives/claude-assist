defmodule Timely.Media.Transform do
  @max_dimension 4096
  @default_quality 85
  ...
  # ⟦𓄑𓂘𓉗𓀴⟧ parse_params :: Parse and validate transform params from query string
  ...
  # ⟦𓆧𓆸𓍀𓆋⟧ has_transforms? :: Check if any transform params are present
  def has_transforms?(params), do: map_size(params) > 0

  @doc "Generate canonical param string for cache key"
  # ⟦𓄤𓌑𓆙𓐟⟧ canonical_params :: Generate canonical param string for cache key
  ...
  # ⟦𓄧𓍤𓊁𓆻⟧ variant_s3_key :: Generate S3 key for a variant
  ...
  # ⟦𓎈𓇂𓍍𓅣⟧ transform :: Transform an image binary according to params
  ...
  # ⟦𓎡𓋈𓐍𓂭⟧ content_type :: auto-generated pointer for public function content_type
