defmodule Timely.StyleGuide.ComponentCatalog do
  @moduledoc """
  Catalog data for the Component Browser — categories + entries with demo keys.
  Demo keys are rendered by `TimelyWeb.Hologram.Sections.ComponentBrowser`.
  """
