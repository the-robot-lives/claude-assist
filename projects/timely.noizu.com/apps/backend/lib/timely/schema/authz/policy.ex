defmodule Timely.Schema.Authz.Policy do
  use Ecto.Schema
  ...
  schema "policies" do
    ...
    belongs_to :created_by_user, Timely.Schema.Users.User,
      type: Ecto.UUID,
      foreign_key: :created_by

    has_many :group_policies, Timely.Schema.Authz.GroupPolicy

    timestamps(type: :utc_datetime_usec, inserted_at: :created_at, updated_at: :updated_at)
  end

  # ⟦𓉫𓍛𓂊𓎚⟧ changeset :: auto-generated pointer for public function changeset
