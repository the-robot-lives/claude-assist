defmodule TimelyWeb.Hologram.Pages.StyleGuidePage do
  @moduledoc """
  ...
  alias TimelyWeb.Hologram.Components.{
    Card,
    CardGrid,
    InputField,
    SectionHeader,
  ...
  alias TimelyWeb.Hologram.Sections.{
    ColorPalette,
    ComponentBrowser,
    HuiShowcase,
    ShellLayouts,
        ...
        {%if @section_id == "migration"}
          <div class="demo-block">
            ...
            <div class="card-grid-actions">
              ...
              <button type="button" class="card card--link card--action" $click={:demo_ping, msg: "Consumer: components/hologram-start-app (TimelyWeb.Hologram.Components)"}>
