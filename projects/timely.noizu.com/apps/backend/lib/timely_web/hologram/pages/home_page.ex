defmodule TimelyWeb.Hologram.Pages.HomePage do
  @moduledoc "Landing page — style-guide cards + CTAs (start-app home)."
  use Hologram.Page

  alias Hologram.UI.Link
  alias TimelyWeb.Hologram.Components.ButtonRow
  alias TimelyWeb.Hologram.Components.Card
  alias TimelyWeb.Hologram.Components.CardGrid
  ...
  alias TimelyWeb.Hologram.Pages.SitemapPage
