defmodule TimelyWeb.Hologram.Pages.ForgotPasswordPage do
  @moduledoc """
  ...
  def command(:request_reset, params, server) do
    case Timely.Auth.SmartTokenAuth.request_password_reset(params.email) do
      {:ok, %{otp_code: code}} ->
        Timely.Auth.SmartTokenEmail.send_password_reset(params.email, code)
  ...
  def command(:verify_reset, params, server) do
    case Timely.Auth.SmartTokenAuth.verify_password_reset(
           params.email,
           params.code,
           params.new_password,
           %{}
