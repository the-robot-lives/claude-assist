defmodule TimelyWeb.UserController do
  ...
  # ⟦𓂮𓇨𓍏𓂷⟧ show :: auto-generated pointer for public function show
  ...
  # ⟦𓏶𓅶𓈃𓁰⟧ update :: auto-generated pointer for public function update
  ...
  # ⟦𓆵𓃤𓀮𓇞⟧ complete_registration :: auto-generated pointer for public function complete_registration
  ...
  defp get_current_user_schema(conn) do
    ...
    Timely.Repo.get!(UserSchema, user_id)
  end
  ...
  defp validate_update_params(user, params) do
    if params["new_password"] && params["current_password"] do
      ...
      q =
        from c in Timely.Schema.Users.Credentials.UserCredential,
  ...
  defp apply_profile_updates(user, params, mark_complete?) do
    Timely.Repo.transaction(fn ->
      ...
      if params["new_password"] do
        case Timely.Users.Credentials.update_password(
               updated_user,
               params["new_password"],
  ...
  defp upsert_name!(name_id, params) do
    ...
    if map_size(attrs) == 0 do
      ...
      case Timely.Repo.get(NameSchema, name_id) do
        nil ->
          insert_name!(params)
