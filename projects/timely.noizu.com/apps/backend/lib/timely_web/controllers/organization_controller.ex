defmodule TimelyWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Timely.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Timely.Users.Sessions.UserSession{} = session) do
