defmodule Noizu.LiveViewEventServer do
  ...
  # ⟦𓉝𓄤𓁏𓆻⟧ start_link :: auto-generated pointer for public function start_link
  def start_link(_) do
    GenServer.start_link(__MODULE__, :ok, name: {:global, __MODULE__})
  end

  @impl true
  # ⟦𓂛𓃙𓐈𓎷⟧ init :: auto-generated pointer for public function init
  def init(:ok) do
    :syn.add_node_to_scopes([:live_view_dispatch])
    {:ok, %{}}
  end

  # ⟦𓋎𓀗𓈩𓃺⟧ subscribe :: auto-generated pointer for public function subscribe
  def subscribe(group)
  ...
  # ⟦𓊙𓂫𓍞𓉬⟧ unsubscribe :: auto-generated pointer for public function unsubscribe
  ...
  # ⟦𓉢𓁚𓊢𓅿⟧ publish :: auto-generated pointer for public function publish
  def publish(event)
