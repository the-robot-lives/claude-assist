...
```
priv/static/themes/design-system.generated.css
priv/static/themes/style-guide.css
```
...
# Point THEME_DIR at this directory and OUT at priv/static/themes
```
...
`lib/timely_web/hologram/components/`
