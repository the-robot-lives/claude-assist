...
A minimal timely theme is provided in `design/themes/timely/`. Copy it to bootstrap a new project:

```bash
# From the project root
mkdir -p design/theme
cp -r design/themes/timely design/theme/theme-myproject
...
```
1. Copy themes/timely/ -> design/theme/theme-{slug}/
...
# Copy timely theme
cp -r start-app/design/themes/timely projects/myproject.com/design/theme/theme-myproject
...
| `themes/timely/` | Minimal YAML seed files — copy to start a new theme |
