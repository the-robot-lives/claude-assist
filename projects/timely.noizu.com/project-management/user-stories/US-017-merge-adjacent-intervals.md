---
id: US-017
title: "Merge adjacent intervals"
slug: merge-adjacent-intervals
...
# US-017: Merge adjacent intervals

## User Story

**As a** daily user  
**I want to** merge adjacent intervals with the same task  
**So that** clean up accidental fragmentation
