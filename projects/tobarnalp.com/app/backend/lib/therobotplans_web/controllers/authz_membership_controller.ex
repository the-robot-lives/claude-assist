defmodule TherobotplansWeb.AuthzMembershipController do
  use TherobotplansWeb, :controller

  alias Therobotplans.Authz.ScopedMemberships
  ...
  def org_members(conn, %{"org_id" => org_id}) do
    ...
    case Therobotplans.Authz.authorize(user_id, "organization", org_id, "viewer") do
      {:ok, _} ->
  ...
  def project_members(conn, %{"project_id" => project_id}) do
    ...
    if Therobotplans.Authz.check_permission(user_id, "project", project_id, "project:view") do
