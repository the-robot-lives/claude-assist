defmodule Therobotmakes.Guardian do
  use Guardian, otp_app: :therobotmakes

  def subject_for_token(%Therobotmakes.Users.Sessions.UserSession{} = session, _claims) do
