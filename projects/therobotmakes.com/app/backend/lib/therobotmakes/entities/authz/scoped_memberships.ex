defmodule Therobotmakes.Authz.ScopedMemberships do
  alias Therobotmakes.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Therobotmakes.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Therobotmakes.Schema.Users.User, on: u.id == sm.member_id,
