defmodule Therobotmakes.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotmakes.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Therobotmakes.Schema.Organizations.InviteToken, Therobotmakes.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Therobotmakes.Users.UserReference
