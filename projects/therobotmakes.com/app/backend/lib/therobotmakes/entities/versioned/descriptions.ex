defmodule Therobotmakes.Versioned.Descriptions do
  alias Therobotmakes.Versioned.Descriptions.Description, as: Entity
  alias Therobotmakes.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
