defmodule Therobotmakes.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotmakes.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Therobotmakes.Schema.Versioned.Names.Name, Therobotmakes.Repo)
