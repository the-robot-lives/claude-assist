defmodule Therobotmakes.Versioned.Strings do
  alias Therobotmakes.Versioned.Strings.String, as: Entity
  alias Therobotmakes.Schema.Versioned.Strings.String, as: Schema
  use Noizu.Repo
