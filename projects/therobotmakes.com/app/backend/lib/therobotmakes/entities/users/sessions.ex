defmodule Therobotmakes.Users.Sessions do
  @moduledoc """
  Context for Therobotmakes.Users.Sessions
  """
  alias Therobotmakes.Users.Sessions.UserSession, as: Entity
  alias Therobotmakes.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Therobotmakes.Users.Sessions.UserSession)
