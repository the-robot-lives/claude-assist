defmodule TherobotmakesWeb.GroupController do
  use TherobotmakesWeb, :controller

  alias Therobotmakes.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Therobotmakes.Repo.get(Therobotmakes.Schema.Authz.Group, id), else: Groups.get_by_name(id)
