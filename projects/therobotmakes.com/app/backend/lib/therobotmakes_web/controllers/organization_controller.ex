defmodule TherobotmakesWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Therobotmakes.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Therobotmakes.Users.Sessions.UserSession{} = session) do
