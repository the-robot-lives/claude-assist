...
config :therobotmakes, Therobotmakes.Repo,
  username: System.get_env("DB_USER", "therobotmakes"),
  password: System.get_env("DB_PASS", "trm_dev"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "trm_dev"),
...
config :therobotmakes, dev_routes: true

config :therobotmakes, :frontend_url, "http://localhost:3000"
