...
alias Iotgo.Schema.Users.User
alias Iotgo.Schema.Organizations.Organization
alias Iotgo.Schema.Organizations.Membership
alias Iotgo.Schema.Organizations.InviteToken
alias Iotgo.Schema.Users.Credentials.UserCredential
alias Iotgo.Schema.Versioned.Names.Name
alias Iotgo.Schema.Versioned.Descriptions.Description

admin_id = UUID.uuid5(:oid, "Iotgo.Dev.Admin")
dev_org_id = UUID.uuid5(:oid, "Iotgo.Dev.Organization")
login_provider_id = UUID.uuid5(:oid, "Iotgo.Schema.Auth.Providers.Provider@Login")

seed "dev:admin-name" do
  Iotgo.Repo.insert!(
    %Name{id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Name"), first: "Admin", last: "User"},
    on_conflict: :nothing,
    conflict_target: :id
  )
end
...
seed "dev:admin-description" do
  Iotgo.Repo.insert!(
    %Description{
      id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Description"),
      title: "Admin",
...
seed "dev:admin-user" do
  Iotgo.Repo.insert!(
    %User{
      ...
      user_name: "admin",
      handle: "admin",
      name_id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Name"),
      description_id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Description"),
...
seed "dev:admin-credential" do
  Iotgo.Repo.insert!(
    %UserCredential{
      id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Credential"),
      user_id: admin_id,
...
seed "dev:admin-membership" do
  Iotgo.Repo.insert!(
    %Membership{
      id: UUID.uuid5(:oid, "Iotgo.Dev.Admin.Membership"),
...
seed "dev:bootstrap-invite" do
  ...
  Iotgo.Repo.insert!(
    %InviteToken{
      id: UUID.uuid5(:oid, "Iotgo.Dev.BootstrapInvite"),
      organization_id: dev_org_id,
...
seed "dev:admin-magic-link-token" do
  admin_ref = Iotgo.Users.User.ref(admin_id)
