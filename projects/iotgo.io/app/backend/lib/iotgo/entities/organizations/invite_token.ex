defmodule Iotgo.Organizations.InviteToken do
  use Noizu.Entities

  @vsn 1.0
  @repo Iotgo.Organizations.InviteTokens
  @sref "invite-token"
  @persistence ecto_store(Iotgo.Schema.Organizations.InviteToken, Iotgo.Repo)
  ...
  def_entity do
    ...
    field :created_by, nil, Iotgo.Users.UserReference
