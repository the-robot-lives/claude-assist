defmodule Iotgo.Versioned.Descriptions do
  alias Iotgo.Versioned.Descriptions.Description, as: Entity
  alias Iotgo.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
