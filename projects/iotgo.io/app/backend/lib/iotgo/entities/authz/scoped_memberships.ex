defmodule Iotgo.Authz.ScopedMemberships do
  alias Iotgo.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias Iotgo.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      join: u in Iotgo.Schema.Users.User, on: u.id == sm.member_id,
