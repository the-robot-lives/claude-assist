defmodule Iotgo.Users.Sessions do
  @moduledoc """
  Context for Iotgo.Users.Sessions
  """
  alias Iotgo.Users.Sessions.UserSession, as: Entity
  alias Iotgo.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: Iotgo.Users.Sessions.UserSession)
