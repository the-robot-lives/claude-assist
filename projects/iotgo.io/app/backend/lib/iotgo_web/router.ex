defmodule IotgoWeb.Router do
  ...
  pipeline :rate_limited_auth do
    plug IotgoWeb.Plugs.RateLimit, action: :auth
  end

  pipeline :rate_limited_sensitive do
    plug IotgoWeb.Plugs.RateLimit, action: :auth_sensitive
  end

  pipeline :org_viewer do
    plug IotgoWeb.Plugs.RequireRole, role: "viewer"
  end

  pipeline :org_editor do
    plug IotgoWeb.Plugs.RequireRole, role: "editor"
  end

  pipeline :org_admin do
    plug IotgoWeb.Plugs.RequireRole, role: "admin"
  end

  pipeline :org_owner do
    plug IotgoWeb.Plugs.RequireRole, role: "owner"
  end

  pipeline :admin do
    plug IotgoWeb.Plugs.RequireAdmin
  end
  ...
  if Application.compile_env(:iotgo, :saml_enabled) do
    scope "/sso/saml" do
  ...
  if Application.compile_env(:iotgo, :dev_routes) do
    import Phoenix.LiveDashboard.Router

    scope "/dev" do
      pipe_through [:fetch_session, :protect_from_forgery]
      live_dashboard "/dashboard", metrics: IotgoWeb.Telemetry
    end
  end
end
