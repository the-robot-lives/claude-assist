defmodule IotgoWeb.AuthzMembershipController do
  use IotgoWeb, :controller

  alias Iotgo.Authz.ScopedMemberships
  ...
  def org_members(conn, %{"org_id" => org_id}) do
    ...
    case Iotgo.Authz.authorize(user_id, "organization", org_id, "viewer") do
      {:ok, _} ->
  ...
  def project_members(conn, %{"project_id" => project_id}) do
    ...
    if Iotgo.Authz.check_permission(user_id, "project", project_id, "project:view") do
