defmodule IotgoWeb.GroupController do
  use IotgoWeb, :controller

  alias Iotgo.Authz.Groups
  ...
  def show(conn, %{"id" => id}) do
    group = if uuid?(id), do: Iotgo.Repo.get(Iotgo.Schema.Authz.Group, id), else: Groups.get_by_name(id)
