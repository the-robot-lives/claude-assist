defmodule IotgoWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case Iotgo.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%Iotgo.Users.Sessions.UserSession{} = session) do
