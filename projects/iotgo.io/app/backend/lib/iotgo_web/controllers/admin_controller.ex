defmodule IotgoWeb.AdminController do
  use IotgoWeb, :controller

  alias Iotgo.Schema.Users.User, as: UserSchema
  alias Iotgo.Schema.Organizations.Organization, as: OrgSchema
  import Ecto.Query
