defmodule Therobotplans.Versioned.Names.Name do
  use Noizu.Entities

  @vsn 1.0
  @repo Therobotplans.Versioned.Names
  @sref "versioned-name"
  @persistence ecto_store(Therobotplans.Schema.Versioned.Names.Name, Therobotplans.Repo)
