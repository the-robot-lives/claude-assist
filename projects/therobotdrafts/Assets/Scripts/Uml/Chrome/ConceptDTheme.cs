...
namespace TheRobotDraft.Uml.Chrome
{
    ...
    public static class ConceptDTheme
    {
        ...
        public static readonly Color Bg = Hex(0x14, 0x18, 0x1b);
        /// <summary>#1a1f23 title/context/status bars.</summary>
        public static readonly Color Bg2 = Hex(0x1a, 0x1f, 0x23);
        /// <summary>#20262b hover / elevated chip.</summary>
        public static readonly Color Bg3 = Hex(0x20, 0x26, 0x2b);
        /// <summary>#171c20 dock panels (browser, inspector, palette).</summary>
        public static readonly Color Panel = Hex(0x17, 0x1c, 0x20);
        /// <summary>#2a3238 hairline / rule.</summary>
        public static readonly Color Line = Hex(0x2a, 0x32, 0x38);
        /// <summary>#333c43 control border.</summary>
        public static readonly Color Line2 = Hex(0x33, 0x3c, 0x43);

        // --- type ---
        /// <summary>#d7dee2 primary text.</summary>
        public static readonly Color Text = Hex(0xd7, 0xde, 0xe2);
        /// <summary>#8a969e secondary / dim labels.</summary>
        public static readonly Color TextDim = Hex(0x8a, 0x96, 0x9e);
        /// <summary>#5b666d faint / section caps.</summary>
        public static readonly Color TextFaint = Hex(0x5b, 0x66, 0x6d);
        ...
        public static readonly Color Accent = Hex(0x37, 0xc8, 0xc3);
        /// <summary>#2a807d accent hover / menu highlight base.</summary>
        public static readonly Color AccentDim = Hex(0x2a, 0x80, 0x7d);
        /// <summary>#062a29 text on solid accent chip.</summary>
        public static readonly Color AccentOn = Hex(0x06, 0x2a, 0x29);
        /// <summary>#ffd9a0 warm selection / Connect mode.</summary>
        public static readonly Color Warm = Hex(0xff, 0xd9, 0xa0);
        /// <summary>#3a2c12 text on warm chip.</summary>
        public static readonly Color WarmOn = Hex(0x3a, 0x2c, 0x12);
        /// <summary>#e06c60 danger only (never decorative).</summary>
        public static readonly Color Danger = Hex(0xe0, 0x6c, 0x60);

        // --- derived form fills ---
        /// <summary>Modal dialog surface (slightly above panel).</summary>
        public static readonly Color Dialog = Hex(0x1c, 0x22, 0x26);
        /// <summary>Popover / dropdown glass (#1d2327 @ ~93%).</summary>
        public static readonly Color Popover = new Color(0x1d / 255f, 0x23 / 255f, 0x27 / 255f, 0.93f);
        /// <summary>Recessed field well (demo .field input bg = --bg).</summary>
        public static readonly Color Field = Bg;
        /// <summary>Secondary push (idle segment / cancel).</summary>
        public static readonly Color Secondary = Bg3;
        /// <summary>Primary filled control (accent-dim for softer push than solid accent).</summary>
        public static readonly Color Primary = AccentDim;
        /// <summary>Menu row idle.</summary>
        public static readonly Color MenuRow = Hex(0x1a, 0x20, 0x24);
        /// <summary>Scroll well / code viewport.</summary>
        public static readonly Color ScrollWell = Hex(0x12, 0x16, 0x19);
        /// <summary>Modal scrim.</summary>
        public static readonly Color Backdrop = new Color(0.02f, 0.03f, 0.04f, 0.45f);
        /// <summary>Selected tree/list row.</summary>
        public static readonly Color SelectionRow = new Color(AccentDim.r, AccentDim.g, AccentDim.b, 0.55f);
        /// <summary>Segment idle cell inside mode control.</summary>
        public static readonly Color SegmentIdle = Bg;
        /// <summary>Progress track.</summary>
        public static readonly Color ProgressTrack = Line2;
        /// <summary>Checkbox unchecked.</summary>
        public static readonly Color Checkbox = Line2;
        /// <summary>Checkbox checked (accent-dim green-teal).</summary>
        public static readonly Color CheckboxOn = Hex(0x2a, 0x80, 0x6a);
