defmodule HoloGraphWeb.ConnCase do
  ...
  using do
    quote do
      ...
      import HoloGraphWeb.ConnCase

      @endpoint HoloGraphWeb.Endpoint
    end
  end
  ...
  def setup_user_and_token(_context \\ %{}) do
    ...
    HoloGraph.Repo.insert!(
      %HoloGraph.Schema.Auth.Providers.Provider{
    ...
    user = %HoloGraph.Schema.Users.User{
    ...
    {:ok, user} = HoloGraph.Repo.insert(user)

    credential = %HoloGraph.Schema.Users.Credentials.UserCredential{
      id: Ecto.UUID.generate(),
      user_id: user.id,
    ...
    {:ok, _credential} = HoloGraph.Repo.insert(credential)

    session = %HoloGraph.Schema.Users.Sessions.UserSession{
      id: Ecto.UUID.generate(),
      user_id: user.id,
      status: :active,
      details: %{}
    ...
    {:ok, session} = HoloGraph.Repo.insert(session)
