defmodule HoloGraphWeb.UserController do
  ...
  defp get_current_user_schema(conn) do
    ...
    HoloGraph.Repo.get!(UserSchema, user_id)
  end
  ...
  defp validate_update_params(user, params) do
    if params["new_password"] && params["current_password"] do
      ...
      q =
        from c in HoloGraph.Schema.Users.Credentials.UserCredential,
  ...
  defp apply_profile_updates(user, params, mark_complete?) do
    HoloGraph.Repo.transaction(fn ->
      ...
      if params["new_password"] do
        case HoloGraph.Users.Credentials.update_password(
               updated_user,
               params["new_password"],
  ...
  defp upsert_name!(name_id, params) do
    ...
    if map_size(attrs) == 0 do
      ...
      case HoloGraph.Repo.get(NameSchema, name_id) do
        nil ->
          insert_name!(params)
