defmodule HoloGraphWeb.OrganizationController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    case HoloGraph.Authz.authorize(user.id, "organization", id, "viewer") do
      {:ok, _membership} ->
  ...
  defp resolve_user(%HoloGraph.Users.Sessions.UserSession{} = session) do
