defmodule HoloGraph.Users.Sessions do
  @moduledoc """
  Context for HoloGraph.Users.Sessions
  """
  alias HoloGraph.Users.Sessions.UserSession, as: Entity
  alias HoloGraph.Schema.Users.Sessions.UserSession, as: Schema
  use Noizu.Repo
  def_repo(entity: HoloGraph.Users.Sessions.UserSession)
