defmodule HoloGraph.Versioned.Descriptions do
  alias HoloGraph.Versioned.Descriptions.Description, as: Entity
  alias HoloGraph.Schema.Versioned.Descriptions.Description, as: Schema
  use Noizu.Repo
