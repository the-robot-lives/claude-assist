defmodule HoloGraph.Authz.ScopedMemberships do
  alias HoloGraph.Authz.ScopedMemberships.ScopedMembership, as: Entity
  alias HoloGraph.Schema.Authz.ScopedMembership, as: Schema
  ...
  def list_for_resource(resource_type, resource_id) do
    from(sm in Schema,
      ...
      on: g.id == sm.group_id,
      join: u in HoloGraph.Schema.Users.User,
