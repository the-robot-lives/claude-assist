defmodule HoloGraph.Auth.SSODomains do
  @moduledoc """
  ...
  def policies do
    explicit = Application.get_env(:holo_graph, :sso_domain_policies, %{})
    legacy = Application.get_env(:holo_graph, :sso_domains, %{})
    auto_approve = Application.get_env(:holo_graph, :sso_auto_approve_domains, [])
