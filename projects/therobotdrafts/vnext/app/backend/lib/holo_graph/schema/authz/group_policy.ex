defmodule HoloGraph.Schema.Authz.GroupPolicy do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:id, Ecto.UUID, autogenerate: true}
  schema "group_policies" do
    belongs_to :group, HoloGraph.Schema.Authz.Group, type: Ecto.UUID
    belongs_to :policy, HoloGraph.Schema.Authz.Policy, type: Ecto.UUID
