...
alias HoloGraph.Schema.Organizations.Organization
alias HoloGraph.Schema.Organizations.Membership
alias HoloGraph.Schema.Organizations.InviteToken
alias HoloGraph.Schema.Users.Credentials.UserCredential
alias HoloGraph.Schema.Versioned.Names.Name
alias HoloGraph.Schema.Versioned.Descriptions.Description

admin_id = UUID.uuid5(:oid, "HoloGraph.Dev.Admin")
dev_org_id = UUID.uuid5(:oid, "HoloGraph.Dev.Organization")
login_provider_id = UUID.uuid5(:oid, "HoloGraph.Schema.Auth.Providers.Provider@Login")

seed "dev:admin-name" do
  HoloGraph.Repo.insert!(
    %Name{id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Name"), first: "Admin", last: "User"},
    on_conflict: :nothing,
    conflict_target: :id
  )
end
...
seed "dev:admin-description" do
  HoloGraph.Repo.insert!(
    %Description{
      id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Description"),
      title: "Admin",
...
seed "dev:admin-user" do
  HoloGraph.Repo.insert!(
    %User{
      ...
      user_name: "admin",
      handle: "admin",
      name_id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Name"),
      description_id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Description"),
...
seed "dev:admin-credential" do
  HoloGraph.Repo.insert!(
    %UserCredential{
      id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Credential"),
      user_id: admin_id,
...
seed "dev:admin-membership" do
  HoloGraph.Repo.insert!(
    %Membership{
      id: UUID.uuid5(:oid, "HoloGraph.Dev.Admin.Membership"),
...
seed "dev:bootstrap-invite" do
  ...
  HoloGraph.Repo.insert!(
    %InviteToken{
      id: UUID.uuid5(:oid, "HoloGraph.Dev.BootstrapInvite"),
      organization_id: dev_org_id,
...
seed "dev:admin-magic-link-token" do
  admin_ref = HoloGraph.Users.User.ref(admin_id)
