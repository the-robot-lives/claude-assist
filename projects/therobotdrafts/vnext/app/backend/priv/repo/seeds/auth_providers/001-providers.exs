...
login_id = UUID.uuid5(:oid, "HoloGraph.Schema.Auth.Providers.Provider@Login")
smart_token_id = UUID.uuid5(:oid, "HoloGraph.Schema.Auth.Providers.Provider@SmartToken")
